...
public class _EJSRemoteCMPBonus_13725080_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteCMPBonus_13725080 target = null;
    private ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:com.ibm.commerce.extension.objects.Bonus:0000000000000000", 
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteCMPBonus_13725080) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 109: 
                    if (method.equals("_get_memberId")) {
                        return _get_memberId(in, reply);
                    }
                case 110: 
    ...
    private OutputStream _get_memberId(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        Long result = target.getMemberId();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,Long.class);
        return out;
