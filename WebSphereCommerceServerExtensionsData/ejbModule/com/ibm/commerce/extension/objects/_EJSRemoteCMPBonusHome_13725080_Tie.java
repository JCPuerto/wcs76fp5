...
public class _EJSRemoteCMPBonusHome_13725080_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteCMPBonusHome_13725080 target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteCMPBonusHome_13725080) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.length()) {
                case 14: 
                    if (method.equals("findByMemberId")) {
                        return findByMemberId(in, reply);
                    }
                case 15: 
                ...
                case 22: 
                    if (method.equals("create__java_lang_Long")) {
                        return create__java_lang_Long(in, reply);
                    }
                case 24: 
                ...
                case 41: 
                    if (method.equals("create__java_lang_Long__java_lang_Integer")) {
                        return create__java_lang_Long__java_lang_Integer(in, reply);
                    }
            }
    ...
    private OutputStream create__java_lang_Long(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
    ...
    private OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        BonusKey arg0 = (BonusKey) in.read_value(BonusKey.class);
        Bonus result;
        try {
    ...
    private OutputStream findByMemberId(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        Long arg0 = (Long) in.read_value(Long.class);
        Bonus result;
        try {
            result = target.findByMemberId(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private OutputStream create__java_lang_Long__java_lang_Integer(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        Long arg0 = (Long) in.read_value(Long.class);
