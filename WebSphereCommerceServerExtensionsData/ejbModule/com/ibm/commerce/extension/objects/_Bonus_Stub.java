...
public class _Bonus_Stub extends Stub implements Bonus {
    ...
    public Long getMemberId() throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    try {
                        OutputStream out = _request("_get_memberId", true);
                        in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                        return (Long) in.read_value(Long.class);
                    } catch (ApplicationException ex) {
                        in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                ...
                ServantObject so = _servant_preinvoke("_get_memberId",com.ibm.commerce.extension.objects.Bonus.class);
                if (so == null) {
                    continue;
                }
                try {
                    Long result = ((com.ibm.commerce.extension.objects.Bonus)so.servant).getMemberId();
                    return (Long)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    throw Util.wrapException(exCopy);
