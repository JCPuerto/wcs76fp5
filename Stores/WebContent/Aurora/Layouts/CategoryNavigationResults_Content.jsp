					...
					<div class="content">
						<div class="header">
							...
							<div class="sorting_controls">
								...
								<select id="orderByContent" name="contentOrderBy" onChange="javaScript:setCurrentId('orderByContent');SearchBasedNavigationDisplayJS.sortResults_content(this.value)">
						...
						<c:forEach items="${contentresults}" var="content" varStatus="status">
							...
							<div class="item">
								<div class="icon">
									<img src="${jspStoreImgDir}${env_vfileColor}widget_articles_videos/${fn:toLowerCase(content.metaData.mimetype)}.png" alt="${content.metaData.mimetype}" /> 
								</div>
								<div class="description">
									<div class="header left"><a class="link" href="${urlValue}">${contentHLName}</a></div>
									<div class="clear_float"></div>
