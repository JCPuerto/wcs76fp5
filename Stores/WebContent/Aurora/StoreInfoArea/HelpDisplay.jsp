							...
							<div class="main_content">
								...
								<div class="container_static_full_width container_margin_5px"> 
									...
									<div class="static_page_content">
										<div class="page_header" role="heading" aria-level="1"><fmt:message key="FOOTER_HELP" /></div>
										<div class="content_box">
											<div class="header_top"><fmt:message key="HELP_MAIN" /></div>
											...
											<%out.flush();%>
												<c:import url="${env_jspStoreDir}Widgets/ESpot/ContentRecommendation/ContentRecommendation.jsp">
													<c:param name="emsName" value="HelpCenter_Content" />
