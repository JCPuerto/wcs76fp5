...
<wcf:getData type="com.ibm.commerce.infrastructure.facade.datatypes.OnlineStoreType"
		...
		<wcf:param name="pageName" value="PRIVACY_PAGE"/>
...
<div id="page">
	...
	<div class="header_wrapper_position" id="headerWidget">
		<c:if test="${param.fromPage != 'registration'}">
			<%out.flush();%>
							...
							<div class="main_content">
								...
								<div class="container_static_full_width container_margin_5px"> 
									...
									<div class="static_page_content">
										<div class="page_header" role="heading" aria-level="1"><fmt:message key="FOOTER_PRIVACY_POLICY" /></div>
										<div class="content_box">
											<div class="header_top"><fmt:message key="PERSONAL_INFO" /></div>
											...
											<%out.flush();%>
												<c:import url="${env_jspStoreDir}Widgets/ESpot/ContentRecommendation/ContentRecommendation.jsp">
													<c:param name="emsName" value="PrivacyPolicyCenter_Content" />
