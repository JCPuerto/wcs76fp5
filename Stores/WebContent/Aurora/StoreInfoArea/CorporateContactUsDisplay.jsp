...
<wcf:getData type="com.ibm.commerce.infrastructure.facade.datatypes.OnlineStoreType"
		...
		<wcf:param name="pageName" value="CORPORATE_CONTACT_US_PAGE"/>
								...
								<div class="container_static_full_width container_margin_5px"> 
									...
									<div class="static_page_content">
										<div class="page_header" role="heading" aria-level="1">
											<fmt:message key="CONTACT_STORE_CORPORATE">
												<fmt:param><c:out value="${storeName}"/></fmt:param>
											</fmt:message>
										</div>
										<div class="content_box">
											<div class="header_top">
												<fmt:message key="STORE_HEAD_OFFICE">
													<fmt:param><c:out value="${storeName}"/></fmt:param>
												</fmt:message>
											</div>
											...
											<%out.flush();%>
												<c:import url="${env_jspStoreDir}Widgets/ESpot/ContentRecommendation/ContentRecommendation.jsp">
													<c:param name="emsName" value="ContactUsCorpCenter_Content" />
