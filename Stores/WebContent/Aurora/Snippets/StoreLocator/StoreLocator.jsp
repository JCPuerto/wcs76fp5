	...
	<c:when test="${fromPage != 'ShoppingCart'}">	
		...
		<div class="gift_header"><span aria-level="2" role="heading"><fmt:message key="STORE_LIST_TITLE"/></span>
			<div id="hideStoreListHeader" class="checkout_show_icon" style="display:block">
				<div id="WC_StoreLocator_div_14" class="hide"><a role="button" id="WC_StoreLocator_links_5" href="Javascript:storeLocatorJS.hideStoreList();"><fmt:message key="STORE_LIST_HIDE" /> <img src="<c:out value='${jspStoreImgDir}images/'/>collapse_icon.gif" border="0" alt=""/></a></div>
			</div>
			<div id="showStoreListHeader" class="checkout_show_icon" style="display:none">
				<div id="WC_StoreLocator_div_18" class="hide"><a role="button" id="WC_StoreLocator_links_6" href="Javascript:storeLocatorJS.showStoreList();"><fmt:message key="STORE_LIST_SHOW" /> <img src="<c:out value='${jspStoreImgDir}images/'/>expand_icon.gif" border="0" alt=""/></a></div>
			</div>
		</div>
	</c:when>
	<c:otherwise>
...
<c:choose>
	...
	<c:when test="${fromPage == 'StoreLocator'}">
		<div class="button_footer_line no_float">
			<a href="#" role="button" class="button_primary" id="continueShoppingStoreLocator" onclick="javascript:setPageLocation('<c:out value="${TopCategoriesDisplayURL}"/>')">
				<div class="left_border"></div>
				<div class="button_text"><fmt:message key="CONTINUE_SHOPPING" /></div>
				<div class="right_border"></div>
			</a>
