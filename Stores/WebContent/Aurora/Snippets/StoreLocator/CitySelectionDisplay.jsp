...
<select name="selectCity" id="selectCity" class="drop_down_country" onchange="Javascript:JavaScript:storeLocatorJS.changeCitySelection(this.options[this.selectedIndex].value);">
