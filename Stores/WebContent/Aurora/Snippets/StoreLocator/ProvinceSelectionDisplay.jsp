...
<select name="selectState" id="selectState" title="<fmt:message key='ACCE_PROVINCE_CHANGE'/>" class="drop_down_country" onchange="JavaScript:storeLocatorJS.changeProvinceSelection(this.options[this.selectedIndex].value);">
