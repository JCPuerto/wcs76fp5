...
<div class="card_info" id="WC_StandardDiscover_div_1_${paymentAreaNumber}">
	<c:choose>
	...
	<input type="hidden" name="cc_brand" value="<c:out value="${cc_brand}" />" id="WC_StandardDiscover_inputs_1_${paymentAreaNumber}"/>
	<input type="hidden" name="paymentTCId" value="<c:out value="${paymentTCId}"/>" id="WC_StandardDiscover_inputs_2_${paymentAreaNumber}"/>
	...
	<span class="col1">
		<span class="card_number">
			<span>
				<span class="required-field">*</span><label for="edp_Discover_account_<c:out value='${paymentAreaNumber}' />"><fmt:message key="EDPPaymentMethods_VISA_CARD_NUMBER" bundle="${storeText}"/></label>
			</span>
			<span>
		...
		<span class="visaCVV2">
			<span id="CVVDetailsSection_${paymentAreaNumber}">			
				<span id="StandardDiscover_CVVDetails_AcceText_${paymentAreaNumber}" style="display:none">
				...
				<span id="StandardDiscover_CVVDetails_${paymentAreaNumber}" class="order_link" title="<fmt:message key='EDPPaymentMethods_CVV_WHAT_IS' bundle='${storeText}'/><fmt:message key='EDPPaymentMethods_CVV_DEFINITION' bundle='${storeText}'/>" onmouseover="javascript: this.title = '';" onmouseout="javascript: this.title = document.getElementById('StandardDiscover_CVVDetails_AcceText_${paymentAreaNumber}').innerHTML;" tabindex="0"><fmt:message key="EDPPaymentMethods_CVV_WHAT_IS" bundle="${storeText}"/></span>
							...
							<div class="content_left_border">
								<div class="content_right_border">
									<div class="content">
										...
										<div id="WC_StandardDiscover_div_4_${paymentAreaNumber}" class="body">
											<fmt:message key="EDPPaymentMethods_CVV_DEFINITION" bundle="${storeText}"/>
										</div>
									</div>
								</div>
