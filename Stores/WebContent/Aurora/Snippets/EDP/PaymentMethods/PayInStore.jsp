...
<div class="card_info" id="WC_PayInStore_div_1_${paymentAreaNumber}">

	<%-- The section to collect the protocol data for this payment method --%>
	<input type="hidden" name="paymentTCId" value="<c:out value="${paymentTCId}"/>" id="WC_PayInStore_inputs_1_${paymentAreaNumber}"/>
