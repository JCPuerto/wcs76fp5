...
<div class="card_info" id="WC_StandardMasterCard_div_1_${paymentAreaNumber}">
	<c:choose>
	...
	<input type="hidden" name="cc_brand" value="<c:out value="${cc_brand}" />" id="WC_StandardMasterCard_inputs_1_${paymentAreaNumber}"/>
	<input type="hidden" name="paymentTCId" value="<c:out value="${paymentTCId}"/>" id="WC_StandardMasterCard_inputs_2_${paymentAreaNumber}"/>
	...
	<span class="col1">
		<span class="card_number">
			<span>
				...
				<span><fmt:message key="EDPPaymentMethods_MAST_CARD_NUMBER" bundle="${storeText}"/></span></label>
			</span>
			<span>
				<input aria-required="true" type="text" onchange="JavaScript:CheckoutPayments.removeCreditCardNumberAndCVV(<c:out value='${paymentAreaNumber}'/>, false, true);CheckoutHelperJS.paymentDataDirty(<c:out value='${paymentAreaNumber}'/>, true);CheckoutPayments.updatePaymentObject(<c:out value='${paymentAreaNumber}'/>, 'account');" style="width:142px"  name="account1" value="<c:out value="${accountValue}"/>" id="account1_${paymentAreaNumber}"/>
			</span>
		</span>	
		<span>
		...
		<span class="visaCVV2">
			<span id="CVVDetailsSection_${paymentAreaNumber}">	
				<span id="StandardMasterCard_CVVDetails_AcceText_${paymentAreaNumber}" style="display:none">
							...
							<div class="content_left_border">
								<div class="content_right_border">
									<div class="content">
										...
										<div id="WC_StandardMasterCard_div_4_${paymentAreaNumber}" class="body">
											<fmt:message key="EDPPaymentMethods_CVV_DEFINITION" bundle="${storeText}"/>
										</div>
									</div>
								</div>
