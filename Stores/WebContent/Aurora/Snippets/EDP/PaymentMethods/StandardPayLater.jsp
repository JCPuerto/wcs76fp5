...
<div class="card_info" id="WC_StandardPayLater_div_1_${paymentAreaNumber}">

	<%-- The section to collect the protocol data for this payment method --%>
	<input type="hidden" name="paymentTCId" value="<c:out value="${paymentTCId}"/>" id="WC_StandardPayLater_inputs_1_${paymentAreaNumber}"/>
