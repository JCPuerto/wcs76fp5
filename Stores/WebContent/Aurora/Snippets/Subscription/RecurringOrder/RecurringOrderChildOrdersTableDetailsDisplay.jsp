...
<div role="columnheader" id="RecurringOrderChildOrdersDetailsDisplayExt_li_header_2" class="li order_scheduled_column"><fmt:message key="ORD_ORDER_DATE" bundle="${storeText}"/></div>
<div role="columnheader" id="RecurringOrderChildOrdersDetailsDisplayExt_li_header_4" class="li order_status_column_history"><fmt:message key="MO_SUBSCRIPTION_STATUS" bundle="${storeText}"/></div>
<div role="columnheader" id="RecurringOrderChildOrdersDetailsDisplayExt_li_header_5" class="li total_price_column"><fmt:message key="TOTAL_PRICE" bundle="${storeText}"/></div>
...
<c:choose>
	...
	<div role="row" id="RecurringOrderChildOrdersDisplay_ul_2_${status.count}" class="ul row">
			...
			<div role="gridcell" id="RecurringOrderChildOrdersDetailsDisplayExt_order_number_<c:out value='${status.count}'/>" class="li order_number_column">
				...
				<a href="<c:out value='${OrderDetailUrl1}'/>" class="myaccount_link hover_underline" id="RecurringOrderChildOrdersDetailLink_NonAjax_<c:out value='${status.count}'/>"><fmt:message key="DETAILS" bundle="${storeText}"/></a>
			</div>
