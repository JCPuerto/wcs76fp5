...
<div role="columnheader" id="SubscriptionChildOrdersDetailsDisplayExt_li_header_1" class="li order_number_column"><fmt:message key="MA_SUBSCRIPTION" bundle="${storeText}"/>
</div>
<div role="columnheader" id="SubscriptionChildOrdersDetailsDisplayExt_li_header_2" class="li next_order_column"><fmt:message key="ORD_ORDER_DATE" bundle="${storeText}"/></div>
<div role="columnheader" id="SubscriptionChildOrdersDetailsDisplayExt_li_header_3" class="li order_status_column_history"><fmt:message key="MO_SUBSCRIPTION_STATUS" bundle="${storeText}"/></div>
