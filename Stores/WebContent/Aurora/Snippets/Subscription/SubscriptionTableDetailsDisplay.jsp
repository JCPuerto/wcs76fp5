...
<fmt:message var="openingBrace" key="OPENING_BRACE" bundle="${storeText}"/>
...
<c:when test="${ShowVerbAllSubscriptions.recordSetTotal <= 0}">
	<div role="row"><div role="gridcell"><fmt:message key="NO_SUBSCRIPTIONS_FOUND" bundle="${storeText}"/></div></div>
</c:when>
<c:otherwise>

<div role="row" id="SubscriptionDetailsDisplayExt_ul_1" class="ul column_heading">
<div role="columnheader" id="SubscriptionDetailsDisplayExt_li_header_1" class="li order_number_column_1"><fmt:message key="MA_SUBSCRIPTION" bundle="${storeText}"/></div>
<div role="columnheader" id="SubscriptionDetailsDisplayExt_li_header_2" class="li next_order_column_1"><fmt:message key="MO_NEXT_ORDER" bundle="${storeText}"/></div>
<div role="columnheader" id="SubscriptionDetailsDisplayExt_li_header_3" class="li next_order_column_1"><fmt:message key="MA_EXPIRY_DATE" bundle="${storeText}"/></div>
<div role="columnheader" id="SubscriptionDetailsDisplayExt_li_header_4" class="li order_status_column_1"><fmt:message key="MO_SUBSCRIPTION_STATUS" bundle="${storeText}"/></div>
<div role="columnheader" id="SubscriptionDetailsDisplayExt_li_header_5" class="li total_price_column_1"><fmt:message key="TABLE_PRICE" bundle="${storeText}"/></div>
<div role="columnheader" id="SubscriptionDetailsDisplayExt_li_header_6" class="li options_column"><span class="spanacce"><fmt:message key="MO_ACCE_BUTTON_COLUMN" bundle="${storeText}"/></span></div>
...
<c:choose>
	...
	<div role="row" id="SubscriptionDisplay_ul_2_${status.count}" class="ul row">
			...
			<div role="gridcell" id="SubscriptionDetailsDisplayExt_subscription_name_<c:out value='${status.count}'/>" class="li order_number_column_1">
				...
				<a href="<c:out value='${SubscriptionDetailUrl1}'/>" class="myaccount_link hover_underline" id="SubscriptionLink_NonAjax_<c:out value='${status.count}'/>"><fmt:message key="DETAILS" bundle="${storeText}"/></a>
			...
			<c:choose>
				<c:when test="${timeDifference >= cancelSubscriptionNoticePeriod1}">
					<fmt:message key="SUBSCRIPTION_CANCEL_PER" bundle="${storeText}" var="cancelMessage"/>
				</c:when>
				<c:otherwise>
					<fmt:message key="SUBSCRIPTION_CANCEL_NOTICE_PERIOD_MSG" bundle="${storeText}" var="cancelMessage"> 
								...
								<div id="SubscriptionDetailsDisplayExt_option_1_<c:out value='${status.count}'/>" class="option_button">
									<div class="option_button">
										<a href="#" class="button_primary" id="SubscriptionDetailsDisplayExt_option_button_link_1_<c:out value='${status.count}'/>" tabindex="0" width="100%" onclick="javaScript:setCurrentId('SubscriptionDetailsDisplayExt_option_button_link_1_<c:out value='${status.count}'/>'); MyAccountDisplay.setSubscriptionDate('<c:out value='${renewTime}'/>'); MyAccountDisplay.prepareSubscriptionRenew('<c:out value='${SubscriptionCopyUrl}'/>');">
											<div class="left_border"></div>
											<div class="button_text"><fmt:message key="MA_RENEW" bundle="${storeText}"/></div>
											<div class="right_border"></div>
										</a>
									</div>
								</div>
