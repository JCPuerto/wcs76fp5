...
<div id="content588">
   ...
   <div id="box">
		...
		<div class="ad" id="ad_Department"> <img src="<c:out value="${category.objectPath}${category.description.fullIImage}"/>" alt="<c:out value="${requestScope.fullImageAltDescription}" />" border="0"/> </div>
	</c:if>
