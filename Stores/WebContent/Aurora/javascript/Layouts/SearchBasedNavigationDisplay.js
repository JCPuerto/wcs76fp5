...
if(typeof(SearchBasedNavigationDisplayJS) == "undefined" || SearchBasedNavigationDisplayJS == null || !SearchBasedNavigationDisplayJS){
	...
	SearchBasedNavigationDisplayJS = {
		...
		appendFilterPriceRange:function(currencySymbol, imgUrlPath, section, removeCaption) {
			...
			filter.innerHTML = "<a href='#' onclick='SearchBasedNavigationDisplayJS.removeFilterPriceRange(\"" + section + "\"); return false;'>" + "<div class='filter_option'><div class='filter_sprite'><img src='" + imgUrlPath + "' alt='" + removeCaption + "' title='" + removeCaption + "'></div><span>" + label + "</span></div></a>";
		...
		appendFilterFacet:function(id, section, imgUrlPath, removeCaption) {
			...
			if(filter == null) {
				...
				filter.innerHTML = "<a href='#' onclick='SearchBasedNavigationDisplayJS.removeFilterFacet(\"" + id + "\", \"" + section + "\"); return false;'>" + "<div class='filter_option'><div class='filter_sprite'><img src='" + imgUrlPath + "' alt='" + removeCaption + "' title='" + removeCaption + "'></div><span>" + label + "</span></div></a>";
				facetFilterList.appendChild(filter);
			}
