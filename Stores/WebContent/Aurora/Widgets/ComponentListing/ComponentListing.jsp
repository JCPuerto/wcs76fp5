...
<%@ include file="ext/ComponentListing_Data.jsp" %>
<c:if test = "${param.custom_data ne 'true'}">
	<%@ include file="ComponentListing_Data.jsp" %>
</c:if>

<%@ include file="ext/ComponentListing_UI.jsp" %>
<c:if test = "${param.custom_view ne 'true'}">
	<%@ include file="ComponentListing_UI.jsp" %>
</c:if>
