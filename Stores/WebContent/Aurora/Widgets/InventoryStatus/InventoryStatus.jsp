...
<flow:ifEnabled feature="InventoryAvailability">
	...
	<%@ include file="ext/InventoryStatus_Data.jsp" %>
	<c:if test = "${param.custom_data ne 'true'}">
		<%@ include file="InventoryStatus_Data.jsp" %>
	</c:if>

	<%@ include file="ext/InventoryStatus_UI.jsp" %>
	<c:if test = "${param.custom_view ne 'true'}">
		<%@ include file="InventoryStatus_UI.jsp" %>
	</c:if>
