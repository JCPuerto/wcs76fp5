...
<div class="genericESpot" id="IntelligentOffer_${espotName}">
	<div class="caption" style="display:none">[<c:out value="${emsName}"/>]</div>
	<div class="ESpotInfo" id="IntelligentOfferInfo_${espotName}">
		<a id="IntelligentOfferESpotLink_${espotName}" 
				...
				<div class="right_border">
					...
					<div class="content">
						<div class="header_bar simple_bar">
							<c:if test="${param.showHeader eq 'true'}"><div class="title">${espotTitle}</div></c:if>
