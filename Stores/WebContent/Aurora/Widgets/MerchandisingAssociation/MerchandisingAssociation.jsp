...
<%@ include file="ext/MerchandisingAssociation_Data.jsp" %>
<c:if test = "${param.custom_data ne 'true'}">
	<%@ include file="MerchandisingAssociation_Data.jsp" %>
</c:if>

<%@ include file="ext/MerchandisingAssociation_UI.jsp" %>
<c:if test = "${param.custom_view ne 'true'}">
	<%@ include file="MerchandisingAssociation_UI.jsp" %>
</c:if>
