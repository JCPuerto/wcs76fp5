													...
													<div id="my_account_billing" role="region" aria-labelledby="my_account_billing_acce_label">
														...
														<div id="WC_MyAccountQuickCheckoutProfileForm_PI_div" ${paymentSectionStyle} >
															...
															<div id="WC_MyAccountQuickCheckoutProfileForm_div_28">
																...
																<c:choose>
																	<c:when test="${!empty errorMessage}">
																		<input aria-required="true" name="pay_temp_account" type="text" class="form_input" size="35" value="" id="pay_temp_account" onChange="javascript:QuickCheckoutProfile.valueChanged('true');"/>
																	</c:when>
																	<c:otherwise>
																		<input aria-required="true" name="pay_temp_account" type="text" class="form_input" size="35" value="<c:out value='${edpMaskBean.maskedString}'/>" id="pay_temp_account" onChange="javascript:QuickCheckoutProfile.valueChanged('true');"/>
																	</c:otherwise>
																</c:choose>
															</div>
