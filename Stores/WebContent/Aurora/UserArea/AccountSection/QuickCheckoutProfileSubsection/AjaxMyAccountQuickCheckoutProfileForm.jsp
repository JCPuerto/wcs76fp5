...
<!-- BEGIN AjaxMyAccountQuickCheckoutProfileForm.jsp -->
		...
		<div class="my_account" id="WC_AjaxMyAccountQuickCheckoutProfileForm_div_1">
			...
			<div class="body" id="WC_AjaxMyAccountQuickCheckoutProfileForm_div_10">
				<form name="QuickCheckout" method="post" action="AjaxPersonChangeServiceCheckoutProfileUpdate" id="QuickCheckout">
					...
					<c:if test="${isBrazilStore}"> 
						<input type=hidden name="pay_CPFNumber" value="${CPFNumber}" id="WC_MyAccountQuickCheckoutProfileForm_inputs_9"/>
					</c:if>
					...
					<div class="shipping_billing_content" id="normal">
						<div id="my_account_billing">
							...
							<div id="WC_AjaxMyAccountQuickCheckoutProfileForm_div_11">
								<span class="required-field" id="WC_AjaxMyAccountQuickCheckoutProfileForm_div_12"> * </span><fmt:message key="REQUIRED_FIELDS" bundle="${storeText}"/>
							</div>
							<br />
							<br />
							...
							<div class="label_spacer" id="WC_AjaxMyAccountQuickCheckoutProfileForm_div_22">
								<label for="payMethodId"><span class="required-field" id="WC_AjaxMyAccountQuickCheckoutProfileForm_div_23"> *</span>
								...
								<div class="label_spacer" id="WC_AjaxMyAccountQuickCheckoutProfileForm_div_24"><label for="pay_temp_account"><span class="required-field" id="WC_AjaxMyAccountQuickCheckoutProfileForm_div_25"> *</span><fmt:message key="CARD_NUMBER" bundle="${storeText}"/></label></div>
								...
								<div class="left" id="WC_AjaxMyAccountQuickCheckoutProfileForm_div_27">
									<div class="label_spacer" id="WC_AjaxMyAccountQuickCheckoutProfileForm_div_28">
										 <label for="pay_expire_month"><span class="required-field" id="WC_AjaxMyAccountQuickCheckoutProfileForm_div_29"> *</span>
							   ...
							   <div class="left" id="WC_AjaxMyAccountQuickCheckoutProfileForm_div_32">
									<div class="label_spacer" id="WC_AjaxMyAccountQuickCheckoutProfileForm_div_33">
										 <label for="pay_expire_year"><span class="required-field" id="WC_AjaxMyAccountQuickCheckoutProfileForm_div_34"> *</span>
...
<!-- END AjaxMyAccountQuickCheckoutProfileForm.jsp -->
