...
<div id="box">
	<div class="my_account" id="WC_AjaxAddressBookForm_div_1">
		<h2 class="myaccount_header"><fmt:message key="ADDRESSBOOK_TITLE" bundle="${storeText}"/></h2>
		<div class="myaccount_subheader" id="WC_AjaxAddressBookForm_div_6">
			<div class="addrbook_header" id="WC_AjaxAddressBookForm_div_8">
				<span class="spanacce">
					<label for="addressId"><fmt:message key="NICKNAME_INT" bundle="${storeText}"/></label>
				</span>
				<select width="10" class="drop_down_address_book" name="addressId" id="addressId" onchange="JavaScript:MessageHelper.hideAndClearMessage();AddressBookFormJS.showFooter();
			...
			<div class="addrbook_header" id="WC_AjaxAddressBookForm_div_22">
				<div class="left" id="WC_AjaxAddressBookForm_div_23">
					<a href="#" role="button" class="button_secondary" id="WC_AjaxAddressBookForm_links_1" onclick="JavaScript:MessageHelper.hideAndClearMessage();AddressBookFormJS.showFooterNew();wc.render.updateContext('addressBookContext', {'addressId':'empty','type':'add'});">
						<div class="left_border"></div>
						<div class="button_text"><fmt:message key="AB_ADDNEW" bundle="${storeText}"/></div>												
				...
				<a href="#" role="button" class="button_secondary button_left_padding" id="WC_AjaxAddressBookForm_links_2" onclick="javascript:setCurrentId('WC_AjaxAddressBookForm_links_2'); AddressBookFormJS.newDeleteAddress('addressId','<c:out value="${AddressDeleteURL}" />','<c:out value="${addressBookFormURL}"/>'); return false;" waistate:controls="addressId">
					<div class="left_border"></div>
					<div class="button_text"><fmt:message key="REMOVE" bundle="${storeText}"/></div>												
					<div class="right_border"></div>
				</a>
	...
	<div id="content_footer">
		<div class="button_footer_line" id="WC_AjaxAddressBookForm_div_16">
			<a href="#" role="button" class="button_primary" id="WC_AjaxAddressBookForm_links_4" onclick="javascript:setCurrentId('WC_AjaxAddressBookForm_links_4'); AddressBookFormJS.updateAddress('AddressForm', '<c:out value="${addressBookFormURL}"/>'); return false;">
				<div class="left_border"></div>
				<div class="button_text"><fmt:message key="UPDATE" bundle="${storeText}"/></div>												
				<div class="right_border"></div>
			</a>
		</div>			
	</div>		
		...
		<div class="button_footer_line" id="WC_AjaxAddressBookForm_div_16a">
			<div class="left" id="WC_AjaxAddressBookForm_div_16b">
				<a href="#" role="button" class="button_primary" id="WC_AjaxAddressBookForm_links_4a" onclick="javascript:setCurrentId('WC_AjaxAddressBookForm_links_4a'); AddressBookFormJS.newUpdateAddressBook('AddressForm', '<c:out value="${addressBookFormURL}"/>'); return false;">
					<div class="left_border"></div>
					<div class="button_text"><fmt:message key="SUBMIT" bundle="${storeText}"/></div>												
					<div class="right_border"></div>
				</a>
			</div>
