...
<p class="myaccount_desc"><fmt:message key="MA_YOURACC" bundle="${storeText}"/></p>
<br />
...
<div class="content" id="WC_MyAccountCenterLinkDisplay_div_5">
	<div class="info" id="WC_MyAccountCenterLinkDisplay_div_6">
		...
		<p><a href="<c:out value='${userRegistrationFormURL}' />" class="myaccount_link hover_underline" id="WC_MyAccountCenterLinkDisplay_inputs_1"><fmt:message key="MA_EDIT" bundle="${storeText}"/></a></p>
	</div>
</div>
...
<flow:ifEnabled feature="TrackingStatus">
	<div class="myaccount_section_header around_border" id="WC_MyAccountCenterLinkDisplay_div_11">
		...
		<div class="left" id="WC_MyAccountCenterLinkDisplay_div_13"><span class="header"><fmt:message key="MA_RECENT_ORDER_HISTORY" bundle="${storeText}"/></span></div>
	...
	<div class="content" id="WC_MyAccountCenterLinkDisplay_div_15">
		<div class="info" id="WC_MyAccountCenterLinkDisplay_div_16">
			...
			<% out.flush();%>				
			<a href="<c:out value='${trackOrderStatusURL}'/>" class="myaccount_link hover_underline" id="WC_MyAccountCenterLinkDisplay_inputs_2"><fmt:message key="MA_VIEWALL" bundle="${storeText}"/></a>
			<br clear="all" />
		</div>
	</div>
	...
	<flow:ifEnabled feature="RecurringOrders">
		<div class="myaccount_section_header around_border" id="WC_MyAccountCenterLinkDisplay_div_56">
			...
			<div class="left" id="WC_MyAccountCenterLinkDisplay_div_58"><span class="header"><fmt:message key="MA_RECENT_SCHEDULEDORDERS" bundle="${storeText}"/></span></div>
		...
		<div class="content" id="WC_MyAccountCenterLinkDisplay_div_60">
			<div class="info" id="WC_MyAccountCenterLinkDisplay_div_61">
				<% out.flush(); %>
					<c:import url="${jspStoreDir}Snippets/Subscription/RecurringOrder/RecurringOrderTableDisplay.jsp" >
						<c:param name="isMyAccountMainPage" value="true"/>
					</c:import>
				<% out.flush();%>				
				<a href="<c:out value='${trackRecurringOrderStatusURL}'/>" class="myaccount_link hover_underline" id="WC_MyAccountCenterLinkDisplay_inputs_4"><fmt:message key="MA_VIEWALL_SCHEDULEDORDERS" bundle="${storeText}"/></a>
				<br clear="all" />
			</div>
		</div>
		<div class="footer" id="WC_MyAccountCenterLinkDisplay_div_62">
			...
			<div class="left" id="WC_MyAccountCenterLinkDisplay_div_64"></div>
	...
	<flow:ifEnabled feature="Subscription">
		<div class="myaccount_section_header around_border" id="WC_MyAccountCenterLinkDisplay_div_66">
			...
			<div class="left" id="WC_MyAccountCenterLinkDisplay_div_68"><span class="header"><fmt:message key="MA_RECENT_SUBSCRIPTIONS" bundle="${storeText}"/></span></div>
		...
		<div class="content" id="WC_MyAccountCenterLinkDisplay_div_70">
			<div class="info" id="WC_MyAccountCenterLinkDisplay_div_71">
				<% out.flush(); %>
					<c:import url="${jspStoreDir}Snippets/Subscription/SubscriptionTableDisplay.jsp" >
						<c:param name="isMyAccountMainPage" value="true"/>
					</c:import>
				<% out.flush();%>				
				<a href="<c:out value='${trackSubscriptionStatusURL}'/>" class="myaccount_link hover_underline" id="WC_MyAccountCenterLinkDisplay_inputs_5"><fmt:message key="MA_VIEWALL_SUBSCRIPTIONS" bundle="${storeText}"/></a>
				<br clear="all" />
			</div>
		</div>
		<div class="footer" id="WC_MyAccountCenterLinkDisplay_div_72">
			...
			<div class="left" id="WC_MyAccountCenterLinkDisplay_div_74"></div>
	...
	<flow:ifEnabled feature="EnableQuotes">
		...
		<div class="content" id="WC_MyAccountCenterLinkDisplay_div_50">
			<div class="info" id="WC_MyAccountCenterLinkDisplay_div_51">
				...
				<% out.flush();%>				
				<a href="<c:out value='${trackQuoteStatusURL}'/>" class="myaccount_link hover_underline" id="WC_MyAccountCenterLinkDisplay_inputs_3"><fmt:message key="MA_VIEWALL_QUOTES" bundle="${storeText}"/></a>
				<br clear="all" />
			</div>
		</div>
