										...
										<div class="title" id="WC_UserRegistrationAddForm_div_2">
											<h1>
												<fmt:message key="UR_PROFILE">
													<fmt:param><fmt:message key="UR_CREATE"/></fmt:param>
													...
													<div class="align" id="WC_UserRegistrationAddForm_div_7">
														<div class="form_2column" id="WC_UserRegistrationAddForm_div_8">
					                                        ...
					                                        <div class="column" id="WC_UserRegistrationAddForm_div_13">
																...
																<input size="35" maxlength="50" aria-required="true" name="logonPassword" id="WC_UserRegistrationAddForm_FormInput_logonPassword_In_Register_1" type="password" value="<c:out value="${paramSource.logonPassword}"/>" />
															</div>
															<div class="column" id="WC_UserRegistrationAddForm_div_16">
																...
																<input size="35" maxlength="50" aria-required="true" name="logonPasswordVerify" id="WC_UserRegistrationAddForm_FormInput_logonPasswordVerify_In_Register_1" type="password" value="<c:out value="${paramSource.logonPassword}"/>" />
															</div>
															<br clear="all" />
															<%-- 
																***
