...
dojo.addOnLoad(function() {
	...
	<div class="my_account_wishlist multiple_wishlist_actions_border hover_underline">
		<div id="create_popup_link" class="left"> <a role="button" class="bopis_link" id="multipleWishlistController_link_create" href="javascript:shoppingListJS${param.parentPage}.showPopup('create');"><fmt:message key="MULTIPLE_WISHLIST_create"/></a> </div>		
			<div id="editDivider" class="multiple_wishlist_link_divider left"></div>
			<div id="edit_popup_link" class="left">
			...
			<div id="deleteDivider" class="multiple_wishlist_link_divider left "></div>
			<div id="delete_popup_link" class="left"> 
