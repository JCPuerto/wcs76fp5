				...
				<flow:ifEnabled feature="RecurringOrders">
					...
					<div id="scheduling_options" style="display: block;">
						...
						<form name="RecurringOrderForm">
							...
							<label for="recurringOrder"><fmt:message key="RECURRING_ORDER_SELECT"/><span id="recurringOrderInfo" tabindex="0" onmouseover="javascript: this.title = '';" onmouseout="javascript: this.title = document.getElementById('recurringOrderAcceText').innerHTML;"
							title="<fmt:message key='WHAT_IS_REC_ORDER'/><fmt:message key='REC_ORDER_POPUP_DESCRIPTION'/>">&nbsp;<img src="<c:out value='${jspStoreImgDir}${vfileColor}info.png'/>" alt="<fmt:message key='RECURRING_ORDER_INFO'/>" border="0"/></span></label>
											...
											<div class="content_right_border">
												<div class="content">
													<div class="header" id="recurringOrderInfoPopUp_div4">
														<span id="recurringOrderInfoPopUp_title"><fmt:message key="WHAT_IS_REC_ORDER"/></span>
														<div class="clear_float"></div>
													</div>
							...
							<script type="text/javascript">
								dojo.addOnLoad(function() { 
									parseWidget("recurringOrderInfoPopUp");
								});
							</script>
						</form>
					</div>
