								...
								<div class="container_full_width">
									...
									<div id="box">
										...
										<div class="button_footer_line" id="WC_MultipleShipmentSummary_div_30_1">
											<flow:ifEnabled feature="SharedShippingBillingPage">
												<a role="button" class="button_secondary" id="WC_MultipleShipmentSummary_link_4" tabindex="0" href="javascript:setPageLocation('<c:out value="${ShippingAndBillingURL}"/>')">
											...
											<flow:ifDisabled feature="SharedShippingBillingPage">
												<a role="button" class="button_secondary" id="WC_MultipleShipmentSummary_link_4a" tabindex="0" href="javascript:setPageLocation('<c:out value="${TraditionalBillingURL}"/>')">
													<div class="left_border"></div>
													<div class="button_text"><fmt:message key="BACK"/><span class="spanacce"><fmt:message key="Checkout_ACCE_back_ship_bill"/></span></div>												
													<div class="right_border"></div>
												</a>		
