						...
						<span class="button_bg">
							<span class="button_top">
								<span class="button_bottom">   
									<a href="JavaScript:CheckoutHelperJS.createAddress(-1,'Shipping');" id="WC_ShippingAddressSelectMultiple_link_1"><fmt:message key="ADD_ADDRESS"/></a>
								</span>
							</span>	
						</span>
					</span>
