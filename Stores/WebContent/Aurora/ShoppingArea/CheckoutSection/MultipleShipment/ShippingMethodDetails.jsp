...
<div class="shipping_method_MS_shipping_info_page" id="WC_ShippingMethodDetails_div_<c:out value='${orderItemId}'/>">
	<p>
		...
		<select class="drop_down_shipping" name="MS_ShippingMode_<c:out value='${orderItemId}'/>" id="MS_ShippingMode_<c:out value='${orderItemId}'/>" onchange="JavaScript:setCurrentId(this.id); CheckoutHelperJS.updateShipModeForThisItem(this,'<c:out value="${orderItemId}"/>')">
		...
		<flow:ifEnabled feature="ShippingInstructions">
			...
			<p>
				<span class="checkbox">
					...
					/>
					<label for="MS_shippingInstructionsCheckbox_<c:out value='${orderItemId}'/>"><span class="text"><fmt:message key="SHIP_SHIPPING_INSTRUCTIONS_ADD" bundle="${storeText}"/></span></label>
				</span>
			</p>
				...
				<span>
					<p>
						<label for="MS_shipInstructions_<c:out value='${orderItemId}'/>">
							<span class="spanacce"><fmt:message key="SHIP_SHIPPING_INSTRUCTIONS_LABEL" bundle="${storeText}"/></span>
						</label>
					</p>
					<p>
		...
		<c:if test="${showFutureOrders}">
			...
			<p>
				<span class="checkbox">
					...
					/>
					<label for="MS_requestShippingDateCheckbox_<c:out value='${orderItemId}'/>"><span class="text"><fmt:message key="SHIP_REQUESTED_DATE_ADD" bundle="${storeText}"/></span></label>
				</span>
			</p>
			<div name="MS_requestShippingDateDiv_<c:out value='${orderItemId}'/>" id="MS_requestShippingDateDiv_<c:out value='${orderItemId}'/>" style="display:<c:out value='${requestShippingDateDivDisplay}'/>">
				<div id="MS_requestedShippingDate_<c:out value='${orderItemId}'/>_label">
					<label for="MS_requestedShippingDate_<c:out value='${orderItemId}'/>">
						<span class="spanacce"><fmt:message key="SHIP_REQUESTED_DATE_LABEL" bundle="${storeText}" /></span>
					</label>
				</div>
