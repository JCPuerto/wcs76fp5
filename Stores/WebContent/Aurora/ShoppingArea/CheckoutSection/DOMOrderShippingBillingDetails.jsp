										...
										<div id="mainContents" style="display:block">			
											<div id="box">
												...
												<div class="body left" id="WC_SingleShipmentDisplay_div_16">
													<div id="shipping">
														<div class="shipping_address" id="WC_SingleShipmentDisplay_div_12">
															...
															<p>&nbsp;</p>
															<a role="button" class="button_secondary" id="WC_SingleShipmentDisplay_links_4" href="javascript:setPageLocation('<c:out value="${StoreSelectionURL}"/>')">
															...
															<div class="body shipping_billing_height" id="WC_SingleShipmentDisplay_div_29a">
																<div id="billing">
																	...
																	<div id="WC_SingleShipmentDisplay_div_29c">
																		<a role="button" class="button_secondary" id="WC_SingleShipmentDisplay_links_6" href="javascript:setPageLocation('<c:out value="${CheckoutAddressURL}"/>')">
																			<div class="left_border"></div>
												...
												<div class="button_footer_line" id="WC_SingleShipmentDisplay_div_32_1">
													<a role="button" class="button_secondary" id="WC_SingleShipmentDisplay_links_7" href="javascript:setPageLocation('<c:out value="${CheckoutAddressURL}"/>')">
														<div class="left_border"></div>
													...
													<a role="button" class="button_primary button_left_padding" id="shippingBillingPageNext" href="JavaScript:setCurrentId('shippingBillingPageNext'); CheckoutPayments.processCheckout('PaymentForm');">
														<div class="left_border"></div>
