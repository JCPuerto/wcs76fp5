			...
			<div id="WC_OrderShippingBillingDetails_div_1">
				<div class="body" id="WC_OrderShippingBillingDetails_div_2">
					...
					<div class="button_align" id="WC_OrderShippingBillingDetails_div_4">
						<a role="button" class="button_primary" id="WC_OrderShippingBillingDetails_links_1" tabindex="0" href="javascript:setPageLocation('<c:out value='${ShoppingCartURL}'/>')">
										...
										<div id="box">                                          
											...
											<flow:ifEnabled feature="SharedShippingBillingPage">
												...
												<div class="main_header" id="WC_ShipmentDisplay_div_22">
													...
													<div class="left" id="WC_ShipmentDisplay_div_24"><span aria-level="1" class="main_header_text" role="heading"><fmt:message key="BILL_BILLING_INFO"/></span></div>
											...
											<div class="button_footer_line" id="WC_ShipmentDisplay_div_32_1"> 
												<a role="button" class="button_secondary" id="WC_ShipmentDisplay_links_5" tabindex="0" href="javascript:setPageLocation('<c:out value='${ShoppingCartURL}'/>')">
													<div class="left_border"></div>
													<div class="button_text"><fmt:message key="BACK"/><span class="spanacce"><fmt:message key="Checkout_ACCE_back_shopping_cart"/></span></div>
													<div class="right_border"></div>
												</a>
												<a role="button" class="button_primary button_left_padding" id="shippingBillingPageNext" tabindex="0" href="JavaScript:setCurrentId('shippingBillingPageNext'); CheckoutPayments.processCheckout('PaymentForm');">
													<div class="left_border"></div>
													<flow:ifEnabled feature="SharedShippingBillingPage">
