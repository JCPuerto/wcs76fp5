										...
										<div class="body shipping_billing_height" id="WC_SingleShipmentSummary_div_13">
											...
											<div class="button_footer_line" id="WC_SingleShipmentSummary_div_31_1">
												<flow:ifEnabled feature="SharedShippingBillingPage">
													<a role="button" class="button_secondary" id="WC_SingleShipmentSummary_links_4" tabindex="0" href="javascript:setPageLocation('<c:out value="${ShippingAndBillingURL}"/>')">
												...
												<flow:ifDisabled feature="SharedShippingBillingPage">
													<a role="button" class="button_secondary" id="WC_SingleShipmentSummary_links_4a" tabindex="0" href="javascript:setPageLocation('<c:out value="${TraditionalBillingURL}"/>')">
														<div class="left_border"></div>
														<div class="button_text"><fmt:message key="BACK"/><span class="spanacce"><fmt:message key="Checkout_ACCE_back_ship_bill"/></span></div>
														<div class="right_border"></div>
													</a>
												...
												<c:choose>
													<c:when test="${isOrderScheduled}">
														<a role="button" class="button_primary button_left_padding" id="singleOrderSummary" tabindex="0" href="javascript:setCurrentId('singleOrderSummary'); CheckoutHelperJS.scheduleOrder(<c:out value='${order.orderIdentifier.uniqueID}'/>,<c:out value='${recurringOrderEnabled}'/>,'<c:out value='${userType}'/>')">
															<div class="left_border"></div>
															<c:choose>
																<c:when test="${scheduledOrderEnabled == 'true'}">
													...
													<c:otherwise>
														<a role="button" class="button_primary button_left_padding" id="singleOrderSummary" tabindex="0" href="javascript:setCurrentId('singleOrderSummary'); CheckoutHelperJS.checkoutOrder(<c:out value="${order.orderIdentifier.uniqueID}"/>,'<c:out value='${userType}'/>','<c:out value='${addressListForMailNotification}'/>')">
															<div class="left_border"></div>
															<div class="button_text"><fmt:message key="ORDER"/></div>												
															<div class="right_border"></div>
														</a>
