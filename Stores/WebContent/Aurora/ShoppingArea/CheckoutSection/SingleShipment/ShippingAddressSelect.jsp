...
<c:if test="${orderBean.personalAddressesAllowedForShipping}">
	...
	<c:if test="${selectedAddressId != -1}" >
		...
		<div class="editAddressLink hover_underline" id="editAddressLink_<c:out value='${param.orderId}'/>" style="display:block;">
			<a href="JavaScript:CheckoutHelperJS.editAddress('singleShipmentAddress','-1','<c:out value='${fn:replace(profileshipping,search01,replaceStr01)}'/>','<c:out value='${fn:replace(profilebilling,search01,replaceStr01)}'/>');CheckoutHelperJS.setLastAddressLinkIdToFocus('WC_ShippingAddressSelectSingle_link_1');" id="WC_ShippingAddressSelectSingle_link_1">
	...
	<div class="newShippingAddressButton hover_underline" id="newShippingAddressLink">
			<a href="JavaScript:setCurrentId('singleShipmentAddress'); CheckoutHelperJS.addNewShippingAddress('Shipping');JavaScript:setCurrentId('singleShipmentAddress'); CheckoutHelperJS.updateAddressForAllItems('singleShipmentAddress');CheckoutHelperJS.setLastAddressLinkIdToFocus('WC_ShippingAddressSelectSingle_link_2');" id="WC_ShippingAddressSelectSingle_link_2">
