								...
								<div class="container_full_width">
									...
									<div id="checkout_crumb">
										...
										<div class="continue_shopping" id="WC_OrderShippingBillingConfirmationPage_div_1">
											<a href="#" role="button" class="button_secondary" id="WC_OrderShippingBillingConfirmationPage_links_1" tabindex="0" onclick="javascript:setPageLocation('<c:out value="${env_TopCategoriesDisplayURL}"/>')">
									...
									<div id="box">
										...
										<c:if test="${userType eq 'G'}">
											...
											<div class="left hover_underline" id="WC_OrderShippingBillingConfirmationPage_div_36">
												<fmt:message key="ORD_SIGN_UP_1"/>&nbsp;<a href="<c:out value='${RegisterURL}'/>" class="order_link" id="WC_OrderShippingBillingConfirmationPage_links_2"><fmt:message key="ORD_SIGN_UP_2"/></a>?
											</div>
										</c:if>
