...
<%-- 
  ...
  *****
--%>
<!-- BEGIN CatalogSearchResultDisplayBody.jsp -->
...
<flow:ifEnabled feature="Analytics">
	<div id="catalog_search_result_information" style="display:none">
		{	searchResult: {
			pageSize: 0, 
			searchTerms: '<c:out value="${WCParam.searchTerm}"/>', 
		 	totalPageNumber: 0, 
		  	...
		  	currentPageNumber: 0
					...
					<br/>
					<span class="font2 strong"><fmt:message key="SEARCH_TIPS" bundle="${storeText}"/></span>
				...
				<c:if test="${advancedSearchResult==true}">	
							...
							<span class="Search_Result_Summary_Text">
								...
								<fmt:message key="SEARCH_PRODUCED" bundle="${storeText}">
									<fmt:param><span class="strong"><c:out value="${totalCount}" escapeXml="false"/></span></fmt:param>
								</fmt:message>&nbsp;
								<br />
								<flow:ifEnabled feature="AdvancedSearch">
									<fmt:message key="SEARCH_REFINE_SEARCH" bundle="${storeText}">
			...
			<c:if test="${totalPages > 1}">
				<span class="paging">
					<c:if test="${recordStart != 0}">
						...
						CatalogSearchDisplayJS.goToResultPage('<c:out value='${SearchDisplayViewPrevURL}'/>', 'catalogSearchResultDisplay_Controller', 'catalogSearchResultDisplay_Context');" id="WC_CatalogSearchResultDisplay_link_3">
					</c:if>
				...
				<c:if test="${!completeIndicator}">
					...
					CatalogSearchDisplayJS.goToResultPage('<c:out value='${SearchDisplayViewNextURL}'/>', 'catalogSearchResultDisplay_Controller', 'catalogSearchResultDisplay_Context');" id="WC_CatalogSearchResultDisplay_link_4">
				</c:if>
	...
	<div class="right" id="WC_CatalogSearchResultDisplay_div_4_1">
		 <span class="views">
			<c:if test="${pageView !='image'}">
				 ...
				 CatalogSearchDisplayJS.goToResultPage('<c:out value='${SearchDisplayImageViewURL}'/>', 'catalogSearchResultDisplay_Controller', 'catalogSearchResultDisplay_Context');" id="WC_CatalogSearchResultDisplay_link_5">
			 ...
			 <c:if test="${pageView !='detailed'}">
				 ...
				 CatalogSearchDisplayJS.goToResultPage('<c:out value='${SearchDisplayFullViewURL}'/>', 'catalogSearchResultDisplay_Controller', 'catalogSearchResultDisplay_Context');" id="WC_CatalogSearchResultDisplay_link_6">
		...
		<c:if test="${totalPages > 1}">
			<span class="paging">
				<c:if test="${recordStart != 0}">
					...
					CatalogSearchDisplayJS.goToResultPage('<c:out value='${SearchDisplayViewPrevURL}'/>', 'catalogSearchResultDisplay_Controller', 'catalogSearchResultDisplay_Context');" id="WC_CatalogSearchResultDisplay_link_7">
				</c:if>
				<img src="<c:out value="${jspStoreImgDir}${vfileColorBIDI}" />paging_back.png" alt="<fmt:message key="CATEGORY_PAGING_LEFT_IMAGE" bundle="${storeText}"/>" />
				<c:if test="${recordStart != 0}">
					</a>
				...
				<c:if test="${!completeIndicator}">
					...
					wc.render.getContextById('catalogSearchResultDisplay_Context').properties['searchResultsPageNum']='<c:out value='${nextPageIndex}'/>';
					CatalogSearchDisplayJS.goToResultPage('<c:out value='${SearchDisplayViewNextURL}'/>', 'catalogSearchResultDisplay_Controller', 'catalogSearchResultDisplay_Context');" id="WC_CatalogSearchResultDisplay_link_8">
				</c:if>
				<img src="<c:out value="${jspStoreImgDir}${vfileColorBIDI}" />paging_next.png" alt="<fmt:message key="CATEGORY_PAGING_RIGHT_IMAGE" bundle="${storeText}"/>" />
				<c:if test="${!completeIndicator}">
					</a>
...
<!-- END CatalogSearchResultDisplayBody.jsp -->
