...
<!-- BEGIN CatalogSearchDisplayBody.jsp -->
...
<head>
	...
	<flow:ifEnabled feature="Analytics">
		...
		<%= BIConfigRegistry.getInstance().getInstrumentation((Integer) pageContext.getAttribute("storeId")) %>
			...
			<div id="box">
				<div id="Search_Area_div">
					<div id="Search_Forms_div">
						<%@ include file="CatalogSearchForm.jspf"%>	</div>
					</div>
...
<!-- END CatalogSearchDisplayBody.jsp -->
