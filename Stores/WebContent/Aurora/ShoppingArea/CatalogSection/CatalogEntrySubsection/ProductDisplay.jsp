...
<%-- 
  *****
  * This JSP imports CachedProductItemDisplay.
...
<c:if test="${!empty catalogNavigationView && !empty catalogNavigationView.catalogEntryView[0]}">
	...
	<c:set property="productId" value="${catEntry.uniqueID}" target="${WCParam}"/>
	<c:set var="productId" value="${WCParam.productId}" />
...
<script type="text/javascript">
	dojo.addOnLoad(function() { 
		...
		<fmt:message key="PRICE" bundle="${storeText}" var="PRICE"/>
		<fmt:message key="TieredPricingDisp" bundle="${storeText}" var="TieredPricingDisp"/>
		<fmt:message key="TieredPricingDispLast" bundle="${storeText}" var="TieredPricingDispLast"/>
		...
		MessageHelper.setMessage("PRICE", <wcf:json object="${PRICE}"/>);
		MessageHelper.setMessage("TieredPricingDisp", <wcf:json object="${TieredPricingDisp}"/>);
		MessageHelper.setMessage("TieredPricingDispLast", <wcf:json object="${TieredPricingDispLast}"/>);
