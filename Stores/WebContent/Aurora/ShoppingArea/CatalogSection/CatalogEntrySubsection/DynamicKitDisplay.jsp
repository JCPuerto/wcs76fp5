...
<%-- 
  *****
  * This JSP imports CachedDynamicKitDisplay.
...
<c:set var="pageTitle" value="${catalogEntryView.title}" />
<c:set var="metaDescription" value="${catalogEntryView.metaDescription}" />
<c:set var="metaKeyword" value="${catalogEntryView.keyword}" />
<c:set var="fullImageAltDescription" value="${catalogEntryView.fullImageAltDescription}" scope="request" />
	...
	<div id="page">
		...
		<div id="content_wrapper_box">
			<%-- 
			  ***
			  *	Start: Main Content
			  * Imports CachedDynamicKitDisplay.
			  ***
			--%>
			<div id="content588">
				<%@ include file="../../../include/MessageDisplay.jspf"%>
				<%out.flush();%>
				<c:import url="${jspStoreDir}Snippets/Catalog/CatalogEntryDisplay/CachedDynamicKitDisplay.jsp">
