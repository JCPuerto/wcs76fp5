...
<script type="text/javascript">
	dojo.addOnLoad(function() {
		...
		fastFinderJS.setBeginIndex('<c:out value="${pageBeginIndex}"/>');
						...
						<div class="fastFinderPagination" id="WC_FastFinderDisplay_div_12">
							...
							<span class="paging">
								<a href="javascript: setCurrentId('WC_FastFinderDisplay_link_1'); filterWithPrevIndex();" id="WC_FastFinderDisplay_link_1">
									<span id="fastFinderDisplayJS_TopLeftPaginationMarker"><img src="<c:out value="${jspStoreImgDir}${vfileColorBIDI}paging_back.png"/>" alt="<fmt:message key="FF_PAGING_BACK" bundle="${storeText}"/>" /></span>
									</a>
								...
								<a href="javascript: setCurrentId('WC_FastFinderDisplay_link_2'); filterWithNextIndex();" id="WC_FastFinderDisplay_link_2">
									<span id="fastFinderDisplayJS_TopRightPaginationMarker"><img src="<c:out value="${jspStoreImgDir}${vfileColorBIDI}paging_next.png"/>" alt="<fmt:message key="FF_VIEWDETAILS" bundle="${storeText}"/>" /></span>
								</a>
							</span>
						</div>
					</div>
					...
					<span class="display_text">
						...
						<span class="paging">
							<a href="javascript: setCurrentId('WC_FastFinderDisplay_link_3'); filterWithPrevIndex();" id="WC_FastFinderDisplay_link_3">
								<span id="fastFinderDisplayJS_BottomLeftPaginationMarker"><img src="<c:out value="${jspStoreImgDir}${vfileColorBIDI}paging_back.png"/>" alt="<fmt:message key="FF_PAGING_BACK" bundle="${storeText}"/>" /></span>
							</a>
							...
							<a href="javascript: setCurrentId('WC_FastFinderDisplay_link_4'); filterWithNextIndex();" id="WC_FastFinderDisplay_link_4">
								<span id="fastFinderDisplayJS_BottomRightPaginationMarker"><img src="<c:out value="${jspStoreImgDir}${vfileColorBIDI}paging_next.png"/>" alt="<fmt:message key="FF_PAGING_NEXT" bundle="${storeText}"/>" /></span>
							</a>
						</span>
					</span>
				</div>
