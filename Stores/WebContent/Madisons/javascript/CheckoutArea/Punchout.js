...
if(typeof(PunchoutJS) == "undefined" || !PunchoutJS || !PunchoutJS.topicNamespace){
	...
	PunchoutJS = {
		...
		displayPopup:function(){
			...
			dojo.style("punchout_popup_container", "display", "inline");
			dijit.byId('punchout_popup_container').closeButtonNode.style.display = 'none';
			dijit.byId('punchout_popup_container').titleNode.style.display = 'none';
