...
wc.service.declare({
	...
	,successHandler: function(serviceResponse) {
		...
		if(CheckoutHelperJS.isAjaxCheckOut()){
			...
			document.location.href="OrderShippingBillingView?langId="+SBServicesDeclarationJS.langId+"&storeId="+SBServicesDeclarationJS.storeId+"&catalogId="+SBServicesDeclarationJS.catalogId+"&selectedNumPaymentMethods="+CheckoutPayments.numberOfPaymentMethods;
		}
	}
