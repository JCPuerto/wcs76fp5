...
<div class="shipping_method" id="WC_SingleShipmentShippingMethodDetails_div_1">
	...
	<p>
		<select class="drop_down" name="singleShipmentShippingMode" id="singleShipmentShippingMode" onchange="JavaScript:setCurrentId(this.id); CheckoutHelperJS.updateShipModeForAllItems(this)">
