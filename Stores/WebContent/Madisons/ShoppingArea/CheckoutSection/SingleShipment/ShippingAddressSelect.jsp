...
<c:if test="${orderBean.personalAddressesAllowedForShipping}">
	...
	<c:if test="${selectedAddressId != -1}" >
		<br/>
		<div class="editAddressLink" id="editAddressLink_<c:out value='${param.orderId}'/>" style="display:block;">
	...
	<!-- new address link -->
	<div class="newShippingAddressButton" id="newShippingAddressLink">
			<a href="JavaScript:setCurrentId('singleShipmentAddress'); CheckoutHelperJS.addNewShippingAddress('Shipping');JavaScript:setCurrentId('singleShipmentAddress'); CheckoutHelperJS.updateAddressForAllItems('singleShipmentAddress');" id="WC_ShippingAddressSelectSingle_link_2">
