...
<div id="page">
	...
	<div id="checkout_crumb">
		<div class="crumb" id="WC_CheckoutPayInStore_div_1">
			...
			<span class="step_arrow"></span>
			<span class="step_off"><fmt:message key="BCT_SHIPPING_AND_BILLING" bundle="${storeText}"/></span>
			<span class="step_arrow"></span>
							...
							<c:otherwise>
									...
									<c:choose>
										<c:when test="${isBrazilStore}"><%-- Regardless of the locale, Brazil store always 
											...
											<c:import url="${jspStoreDir}Snippets/ReusableObjects/UnregisteredCheckoutAddressEntryForm.jsp">
										...
										<c:when test="${locale == 'zh_CN'}">
											<c:import url="${jspStoreDir}Snippets/ReusableObjects/UnregisteredCheckoutAddressEntryForm_CN.jsp">
												<c:param name="formName" value="${formName}" />
												<c:param name="divNum" value="${divNum}"/>
												<c:param name="stateDivName1" value="${stateDivName1}"/>
												<c:param name="address" value="${address}"/>	
										...
										<c:when test="${locale == 'zh_TW'}">
											<c:import url="${jspStoreDir}Snippets/ReusableObjects/UnregisteredCheckoutAddressEntryForm_TW.jsp">
												<c:param name="formName" value="${formName}" />
												<c:param name="divNum" value="${divNum}"/>
												<c:param name="stateDivName1" value="${stateDivName1}"/>
												<c:param name="address" value="${address}"/>	
										...
										<c:when test="${locale eq 'ar_EG'}">
											<c:import url="${jspStoreDir}Snippets/ReusableObjects/UnregisteredCheckoutAddressEntryForm_AR.jsp">
												<c:param name="formName" value="${formName}" />
												<c:param name="divNum" value="${divNum}"/>
												<c:param name="stateDivName1" value="${stateDivName1}"/>
												<c:param name="address" value="${address}"/>	
										...
										<c:when test="${locale == 'ru_RU'}">
											<c:import url="${jspStoreDir}Snippets/ReusableObjects/UnregisteredCheckoutAddressEntryForm_RU.jsp">
												<c:param name="formName" value="${formName}" />
												<c:param name="divNum" value="${divNum}"/>
												<c:param name="stateDivName1" value="${stateDivName1}"/>
												<c:param name="address" value="${address}"/>	
										...
										<c:when test="${locale == 'ja_JP' || locale == 'ko_KR'}">
											<c:import url="${jspStoreDir}Snippets/ReusableObjects/UnregisteredCheckoutAddressEntryForm_JP_KR.jsp">
												<c:param name="formName" value="${formName}" />
												<c:param name="divNum" value="${divNum}"/>
												<c:param name="stateDivName1" value="${stateDivName1}"/>
												<c:param name="address" value="${address}"/>	
										...
										<c:when test="${locale == 'de_DE' || locale == 'es_ES' || locale == 'fr_FR' || locale == 'it_IT' || locale == 'ro_RO'}">
											<c:import url="${jspStoreDir}Snippets/ReusableObjects/UnregisteredCheckoutAddressEntryForm_DE_ES_FR_IT_RO.jsp">
												<c:param name="formName" value="${formName}" />
												<c:param name="divNum" value="${divNum}"/>
												<c:param name="stateDivName1" value="${stateDivName1}"/>
												<c:param name="address" value="${address}"/>	
										...
										<c:when test="${locale == 'pl_PL'}">
											<c:import url="${jspStoreDir}Snippets/ReusableObjects/UnregisteredCheckoutAddressEntryForm_PL.jsp">
												<c:param name="formName" value="${formName}" />
												<c:param name="divNum" value="${divNum}"/>
												<c:param name="stateDivName1" value="${stateDivName1}"/>
												<c:param name="address" value="${address}"/>	
