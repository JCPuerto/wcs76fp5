...
xmlns:waistate="http://www.w3.org/2005/07/aaa" lang="${shortLocale}" xml:lang="${shortLocale}">
	...
	<body id="punchout_payment_redirect_page">
		...
		<script type="text/javascript">
			dojo.addOnLoad(function(){cursor_clear();PunchoutJS.pay(<wcf:out value="${param.orderId}" escapeFormat="js"/>, <wcf:out value="${param.piId}" escapeFormat="js"/>, "punchout_payment_redirect", true);});
		</script>
	</body>
</html>
