	...
	<div id="content_wrapper_border">
		...
		<div id="discount_details_box">
			...
			<%--
				...
				***
			--%>
			<div id="discount_details_title" class="title"><h1><fmt:message key="DISCOUNT_DETAILS_TITLE" bundle="${storeText}"/></h1></div>
			<div id="discount_details_content_header" class="contentgrad_header">
				<div id="discount_details_content_header_left_corner" class="left_corner"></div>
				<div id="discount_details_content_header_left" class="left"></div>
				<div id="discount_details_content_header_right_corner"class="right_corner"></div>
			</div>
			<div id="discount_details_content" class="content">
				<div id="discount_details_content_details" class="details">
					<c:choose>
						<c:when test="${ !empty calculationCodeDBs }"  >
							<div id="WC_DiscountDetailsDisplay_div_1">
								<%-- Show the description of the discount --%>
								<h1><c:out value="${calculationCodeDBs[0].descriptionString}" /></h1>
							</div>
												...
												<table cellpadding="0" cellspacing="0" border="0" id="WC_DiscountDetailsDisplay_Table_4">
															...
															<c:if test="${empty discountCatalogEntryDB.dynamicKitDataBean}" >
																	<span class="productName">
																		...
																		<wcf:url var="ProductDisplayURL" patternName="ProductURL" value="Product1">
																			...
																			<wcf:param name="storeId" value="${WCParam.storeId}" />
																			<wcf:param name="catalogId" value="${WCParam.catalogId}" />
																			<wcf:param name="productId" value="${discountCatalogEntryDB.catalogEntryReferenceNumber}" />
																			<wcf:param name="urlLangId" value="${urlLangId}" />
																		</wcf:url>
																		...
																		<c:otherwise>
																			...
																			<c:choose>
																				...
																				<%--	The empty gif are put in front of the prices so that the alt text can be read by the IBM Homepage Reader to describe the two prices displayed.
																					...
																					<span class="price">
																						<fmt:formatNumber value="${discountItemDB.calculatedContractPrice.amount}" type="currency" currencySymbol="${CurrencySymbolToFormat}" maxFractionDigits="${currencyDecimal}"/>
													...
													<tr>
														<td colspan="<c:out value="${maxInRow}"/>" id="WC_DiscountDetailsDisplay_TableCell_12">
															<br />
															<span class="discount">
																<fmt:message key="DETAILED_DISCOUNT_DISCLAIMER" bundle="${storeText}"/>
															</span>
														</td>
													</tr>
												</table>
			...
			<div id="discount_details_footer" class="footer">
				<div id="discount_details_footer_left_corner" class="left_corner"></div>
				<div id="discount_details_footer_left" class="left"></div>
				<div id="discount_details_footer_right_corner" class="right_corner"></div>
			</div>
		</div>
	</div>
		<!-- Content End -->
