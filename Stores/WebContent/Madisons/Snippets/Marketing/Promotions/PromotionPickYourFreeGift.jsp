                             ...
                             <span class="button_bg"> 
	                             <span class="button_top"> 
 	                                <span class="button_bottom"> 
 	                                	<a href="#" id="PickYourFreeGift" class="button_text" onClick="javascript: wc.render.updateContext('PromotionFreeGifts_Context',{rewardOptionID: ${rewardOptions.rewardOptionIdentifier.uniqueID}, isShoppingCartPage:'${shoppingCartPage}'});">
										<c:choose>	
