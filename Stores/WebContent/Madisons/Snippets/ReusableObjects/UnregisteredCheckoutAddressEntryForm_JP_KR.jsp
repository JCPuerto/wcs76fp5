...
<%-- phone --%>
<div class="label_spacer" id="WC_${formName}_phone1_div_26"><label for="<c:out value='WC_${pageName}_ShoppingCartAddressEntryForm_${formName}_${paramPrefix}phone1_1'/>" class="nodisplay">
<fmt:message key="SHIPPING_AND_BILLING_ADDRESS_LABEL_TEXT" bundle="${storeText}">
