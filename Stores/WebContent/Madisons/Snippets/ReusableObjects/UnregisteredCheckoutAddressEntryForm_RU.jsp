...
<div class="label_spacer" id="WC_${formName}_middleName_div_30">
	<label for="<c:out value='WC_${pageName}_ShoppingCartAddressEntryForm_${formName}_${paramPrefix}middleName_1'/>" class="nodisplay">
	<fmt:message key="SHIPPING_AND_BILLING_ADDRESS_LABEL_TEXT" bundle="${storeText}">
	<fmt:param><fmt:message key="MIDDLE_NAME" bundle="${storeText}"/></fmt:param>
	<fmt:param>${address}</fmt:param>
	<fmt:param> </fmt:param></fmt:message>
	</label>
	<fmt:message key="MIDDLE_NAME" bundle="${storeText}"/></div>
...
<div id="WC_${formName}_country_div_24">
	<select name="country" size="1" id="<c:out value='WC_${pageName}_ShoppingCartAddressEntryForm_${formName}_${paramPrefix}country_1'/>" class="drop_down_checkout" onkeydown="saveTabPress(event)" onblur="setFocus('WC_${pageName}_ShoppingCartAddressEntryForm_${formName}_${paramPrefix}state_1')" onchange="javascript:AddressHelper.loadStatesUI('<c:out value='${formName}'/>','<c:out value='${paramPrefix}'/>','<c:out value='${paramPrefix}stateDiv${divNum}'/>','<c:out value="WC_${pageName}_ShoppingCartAddressEntryForm_${formName}_${paramPrefix}state_1"/>')">
