...
<!-- BEGIN HelpContactUsDisplay.jsp -->
         ...
         <div class="help_privacy" id="WC_HelpContactUsDisplay_div_1">
            ...
            <div class="content" id="WC_HelpContactUsDisplay_div_18">
               ...
               <div class="info" id="WC_HelpContactUsDisplay_div_20">
                        ...
                        <c:forEach var="onlineStoreContact" items="${onlineStore.onlineStoreContactInfo}">
                           <c:if test="${onlineStoreContact.language == param.langId}">
                              <c:set var="contact" value="${onlineStoreContact}" />		
                           </c:if>
                        </c:forEach>
