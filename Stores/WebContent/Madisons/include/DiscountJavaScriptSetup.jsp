...
<script type="text/javascript">
	...
	function <wcf:out value="${param.jsPrototypeName}" escapeFormat="js"/>1() {
	...
	***
	...
	<wcf:out value="${param.jsPrototypeName}" escapeFormat="js"/>1.prototype.getThisCategoryDiscountText = function()
	{
		return this.thisCategoryDiscount;
	}
	
	// Function getCategoryDiscountText(categoryId);
	<wcf:out value="${param.jsPrototypeName}" escapeFormat="js"/>1.prototype.getCategoryDiscountText = function(categoryId)
	{
	...
	<wcf:out value="${param.jsPrototypeName}" escapeFormat="js"/>1.prototype.getProductDiscountText = function(productId)
	{
	...
	<wcf:out value="${param.jsPrototypeName}" escapeFormat="js"/>1.prototype.getItemDiscountText = function(itemId)
	{
	...
	<wcf:out value="${param.jsPrototypeName}" escapeFormat="js"/>1.prototype.getAreThereAnyDiscounts = function() {
		return this.foundDiscount;
	}
	
	<%-- Create the discount object now --%>
	var <wcf:out value="${param.jsPrototypeName}" escapeFormat="js"/> = new <wcf:out value="${param.jsPrototypeName}" escapeFormat="js"/>1();
...
<!-- END DiscountJavaScriptSetup.jsp -->
