...
<div class="content" id="WC_MyAccountCenterLinkDisplay_div_5">
	...
	<c:choose>
		<c:when test="${isChinaStore && locale == 'zh_CN'}">
			<div class="info_table">
				<div class="row">
					<div class="label"><fmt:message key="ADDR_NAME" bundle="${MayUJoyText}"/></div>
					<div class="info_content"><c:out value="${firstName} ${middleName} ${lastName}"/></div>
					<div class="clear_float"></div>
				</div>
				<div class="row">
					<div class="label"><fmt:message key="ADDR_ADDRESS" bundle="${MayUJoyText}"/></div>
					<div class="info_content"><c:out value="${city}"/> <c:out value="${street2}"/> <c:out value="${street}"/> </div>
					<div class="clear_float"></div>
				</div>			
				<div class="row">
					<div class="label"><fmt:message key="ADDR_EMAIL" bundle="${MayUJoyText}"/></div>
