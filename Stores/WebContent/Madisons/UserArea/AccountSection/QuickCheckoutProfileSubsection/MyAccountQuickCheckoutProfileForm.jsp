							...
							<div class="shipping_billing_content" id="normal">
								<div id="my_account_billing">
                                   <legend class="myaccount_link_legend"><fmt:message key="QC_BILLINGADDR" bundle="${storeText}"/></legend>
										...
										<span class="required-field"  id="WC_MyAccountQuickCheckoutProfileForm_div_14"> *</span><fmt:message key="REQUIRED_FIELDS" bundle="${storeText}"/>
									</div>
									<br/>
                                 ...
                                 <div id="WC_MyAccountQuickCheckoutProfileForm_PI_div" ${paymentSectionStyle} >
                                   ...
                                   <div class="label_spacer" id="WC_MyAccountQuickCheckoutProfileForm_div_23">
                                        <label for="payMethodId"><span class="required-field"  id="WC_MyAccountQuickCheckoutProfileForm_div_24"> *</span>
                                   ...
                                   <c:set var="displayMethod" value="display:block" />
									...
									<div class="label_spacer" id="WC_MyAccountQuickCheckoutProfileForm_div_26"><label for="pay_temp_account"><span class="required-field"  id="WC_MyAccountQuickCheckoutProfileForm_div_27"> *</span><fmt:message key="CARD_NUMBER" bundle="${storeText}"/></label></div>
								...
								<div id="expiry_yearmonth">
                                   <div class="left" id="WC_MyAccountQuickCheckoutProfileForm_div_29">
                                        <div class="label_spacer" id="WC_MyAccountQuickCheckoutProfileForm_div_30">
                                             <label for="pay_expire_month"><span class="required-field"  id="WC_MyAccountQuickCheckoutProfileForm_div_31"> *</span>
