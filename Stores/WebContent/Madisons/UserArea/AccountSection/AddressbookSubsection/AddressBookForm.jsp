...
<div id="page">
	...
	<script type="text/javascript">
		if('<wcf:out value="${WCParam.addressDeleted}" escapeFormat="js"/>'=='true'){
			dojo.addOnLoad(function() { 
				MessageHelper.displayStatusMessage(MessageHelper.messages["AB_DELETE_SUCCESS"]);
			});
		}
		if('<wcf:out value="${WCParam.addressNew}" escapeFormat="js"/>'=='true'){
			dojo.addOnLoad(function() { 
		...
		<div class="my_account" id="WC_AddressBookForm_div_2">
			...
			<div class="content" id="WC_AddressBookForm_div_7">
												...
												<span class="button_bg">
													<span class="button_top">
														<span class="button_bottom">   
															<a href="#" onclick="javascript:MessageHelper.hideAndClearMessage();AddressBookFormJS.clearTextFields(document.AddressForm1); AddressBookFormJS.showAdd();" id="WC_AddressBookForm_links_1"><fmt:message key="AB_ADDNEW" bundle="${storeText}"/></a>
														</span>
													</span>
												</span>	
											</span>
				...
				<div id="normal" style='<c:out value="${div1}"/>'>
					...
					<script type="text/javascript">
						dojo.addOnLoad(function() {
							<c:if test="${!empty errorMessage && !empty WCParam.addressId}">
								for (i=0; i<document.getElementById("addressId").options.length; i++) {
									if (document.getElementById("addressId").options[i].value == '<wcf:out value='${WCParam.addressId}' escapeFormat='js'/>') {
										document.getElementById("addressId").options[i].selected = "selected";
									}
								}
							</c:if>
							var selection = document.getElementById("addressId");
							AddressBookFormJS.populateTextFieldsOnLoad(selection,addresses,document.AddressForm);
							});
					</script>	
								...
								<div class="align" id="WC_AddressBookForm_div_24">
									...
									<div id="WC_AddressBookForm_div_28">
										...
										<div class="column" id="WC_AddressBookForm_div_31">
											<span class="required-field"  id="WC_AddressBookForm_div_32"> *</span><fmt:message key="REQUIRED_FIELDS" bundle="${storeText}"/>
										</div>
										<br clear="all"/>
										<br/>
										<div class="column" id="WC_AddressBookForm_div_33">
											<div class="label_spacer" id="WC_AddressBookForm_div_34">
												...
												<span class="required-field"  id="WC_AddressBookForm_div_35"> *</span>
