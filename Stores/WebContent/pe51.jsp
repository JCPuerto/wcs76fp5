...
<%
  ...
  <A href="pe51.jsp?<%=ECConstants.EC_CATEGORY_ID%>=<%= categoryId %>&<%=ECConstants.EC_LANGUAGE_ID%>=<%= languageId %>&<%=ECConstants.EC_STORE_ID%>=<%=store%>"><IMG src="<%=resetAllImage%>" alt="<%=undoAll%>" border="0"></A>
