...
<!-- ===========================================================================
     Query to retrieve the catalog override group catalog entries.
     @param UniqueID
		List of unique identifiers for catalog entries
     @param catOverrideGroupID
		The unique identifier of the catalog override group.  
     =========================================================================== -->
BEGIN_XPATH_TO_SQL_STATEMENT
	...
	sql=
		...
		CATENTDESCOVR.LANGUAGE_ID = ($CTX:LANG_ID$) 	
END_XPATH_TO_SQL_STATEMENT
