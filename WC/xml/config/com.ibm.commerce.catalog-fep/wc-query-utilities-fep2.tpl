...
<!-- ========================================================================= -->
BEGIN_SQL_STATEMENT
	name=SELECT_STORECENT
	base_table=STORECENT
	sql=
		SELECT STORECENT.STOREENT_ID
		  FROM STORECENT 
		 WHERE STORECENT.CATENTRY_ID = ?catEntryId?
END_SQL_STATEMENT
...
<!-- ========================================================================= -->
BEGIN_SQL_STATEMENT
	name=SELECT_STORECGRP
	base_table=STORECGRP
	sql=
		SELECT STORECGRP.STOREENT_ID
		  FROM STORECGRP 
		 WHERE STORECGRP.CATGROUP_ID = ?catGroupId?
END_SQL_STATEMENT
