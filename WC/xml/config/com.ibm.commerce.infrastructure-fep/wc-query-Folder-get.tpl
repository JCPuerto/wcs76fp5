...
BEGIN_XPATH_TO_SQL_STATEMENT
	...
	sql=	
	    ...
	    AND
	    	FOLDERITEM.STOREENT_ID in ($STOREPATH:catalog$, $STOREPATH:promotions$)
	    ORDER BY			
...
BEGIN_XPATH_TO_SQL_STATEMENT
	...
	sql=
		...
		AND
			STOREENT_ID in ($STOREPATH:catalog$, $STOREPATH:promotions$)
		ORDER BY
			STOREENT_ID ASC, FOLDER.IDENTIFIER ASC
END_XPATH_TO_SQL_STATEMENT
...
BEGIN_XPATH_TO_SQL_STATEMENT
	...
	sql=
		...
		AND
			FOLDER.STOREENT_ID IN ($STOREPATH:catalog$, $STOREPATH:promotions$)
		ORDER BY
			STOREENT_ID ASC, FOLDER.IDENTIFIER ASC
END_XPATH_TO_SQL_STATEMENT
