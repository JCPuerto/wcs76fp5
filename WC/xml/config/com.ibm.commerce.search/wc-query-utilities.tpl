...
BEGIN_SQL_STATEMENT
	<!-- Fetch all attributes and related properties from SRCHATTR, SRCHATTRPROP, FACET, FACETCATGRP, ATTRVAL, ATTRVALDESC -->
	...
	sql=
		SELECT SRCHATTR.INDEXTYPE, SRCHATTR.INDEXSCOPE, SRCHATTR.IDENTIFIER, SRCHATTRPROP.PROPERTYNAME, 
			SRCHATTRPROP.PROPERTYVALUE, SRCHATTR.SRCHATTR_ID, FACET.SELECTION, FACET.MAX_DISPLAY
		FROM SRCHATTR
