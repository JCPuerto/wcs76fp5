 	   ...
 	   <object objectType="TaskGroupHistory" readonly="true"> 
              ...
              <c:choose>
               <c:when test="${type == 'Catalog' || type == 'InheritedCatalog' || type == 'Product' ||   type == 'InheritedProduct' ||
                ...
                type == 'CategoryPage' ||  type == 'InheritedCategoryPage' ||  type == 'ProductPage' ||  type == 'InheritedProductPage' ||  type == 'ItemPage' ||  type == 'InheritedItemPage' ||  
                type == 'BundlePage' ||  type == 'InheritedBundlePage' ||  type == 'StaticKitPage' ||  type == 'InheritedStaticKitPage' ||  type == 'DynamicKitPage' ||  type == 'InheritedDynamicKitPage' ||  
                type == 'CatalogEntryPage' ||  type == 'InheritedCatalogEntryPage' ||  type == 'HomePage' ||  type == 'InheritedHomePage' ||  type == 'HelpPage' ||  type == 'InheritedHelpPage' ||  
