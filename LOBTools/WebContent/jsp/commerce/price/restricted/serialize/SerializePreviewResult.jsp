...
if(org.apache.commons.lang.StringUtils.isNotEmpty(previewInput)&&org.apache.commons.lang.StringUtils.isNumeric(previewInput.replace(".", ""))&&roundingDefinitionGrid.size()>0&&previewCurrencies.size()>0){
	...
	for(String aCurrency:previewCurrencies){
		BigDecimal aResult = com.ibm.commerce.price.rule.runtime.util.PriceRuleHelper.getInstance().applyRounding(roundingDefinitionsString, previewInputNumber, aCurrency);
		previewResultMap.put(aCurrency, aResult.setScale(2,java.math.BigDecimal.ROUND_FLOOR));
	}
}
%>
