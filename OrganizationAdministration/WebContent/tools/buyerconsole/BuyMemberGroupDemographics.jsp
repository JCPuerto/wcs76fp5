...
<%@ include file="GenderPanel.jsp" %>
<%@ include file="AgePanel.jsp" %>
<%@ include file="IncomePanel.jsp" %>
<%@ include file="MaritalStatusPanel.jsp" %>
<%@ include file="ChildrenPanel.jsp" %> 
<%@ include file="HouseholdPanel.jsp" %> 
 <p></p>
</FORM>
