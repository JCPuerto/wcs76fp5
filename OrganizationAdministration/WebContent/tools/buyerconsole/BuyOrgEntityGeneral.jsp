...
<%} else {%>
	...
	<INPUT size="30" type="text" name="shortName" value="<%= strOrgEntityName %>" id="shortName1">
<%}%>
</TD>
</TR>
<TR>
...
<TD>
	...
	<INPUT size="30" type="text" name="description" value="<%= strDescription %>" id="description1">
</TD>
</TR>
<TR>
<TD>
	<label for="buscat1"><%= UIUtil.toHTML((String)orgEntityNLS.get("OrgEntityGeneralBusCat")) %></label><BR>
	<INPUT size="30" type="text" name="buscat" value="<%= strBusinessCategory %>" id="buscat1">
</TD>
</TR>
