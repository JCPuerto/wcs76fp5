...
<%@ include file="RegistrationDatePanel.jsp" %>
<%@ include file="RegistrationChangeDatePanel.jsp" %>
<%@ include file="InterestsPanel.jsp" %>
<%@ include file="CompanyPanel.jsp" %>
<%-- @ include file="CurrencyPanel.jsp" --%><%-- problem: currency databean uses storeId --%>
<%@ include file="LanguagePanel.jsp" %>
<%@ include file="JobFunctionPanel.jsp" %>
<%@ include file="PreferredCommunicationPanel.jsp" %>
