...
<table id='LUS_table'>
   <tbody>    
     <tr> <!-- Building GUI Body Parts BEGIN ------------------------------>
     	 <td valign="top" id="LUS_TableCell_SelectText"><label for="LUS_FormInput_QuickTextEntry"><%= adminConsoleRB.get("orgSelectParentOrg") %></label></td>
         <td valign="top" id="LUS_TableCell_SearchText"><label for="LUS_SearchTextField1"><%= adminConsoleRB.get("orgSearchParentOrg") %></label></td>
      </tr>
      <tr>
         <!----------------------------------------------------------->
               ...
               <tbody>
                  <tr>
                     <td id="LUS_TableCell_QuickNavigation">
                        ...
                        <label for="LUS_SearchResultListBox1" class="hidden-label"><%= adminConsoleRB.get("SelectSearchResult") %></label>
               ...
               <tbody>
                  <tr>
                     <td id="LUS_TableCell_KeywordSearch">
                        ...
                        <label for="LUS_CriteriaDropDown1" class="hidden-label"><%= adminConsoleRB.get("SearchOptions") %></label>                                
                  ...
                  <tr>
                     <td align="right" id="LUS_FormInput_FindAction">
                        <button name="LUS_ActionButton" class="general" onclick="javascript:LUS_FindAction();"><%= adminConsoleRB.get("find") %></button><br />
                     </td>
                  </tr>
               </tbody>
            </table>
