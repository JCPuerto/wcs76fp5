...
function validateRegistrationDate() {
	with (document.segmentForm) {
		var selectValue = getSelectValue(<%= SegmentConstants.ELEMENT_REGISTRATION_DATE_OP %>);
		if ((selectValue == "before" || selectValue == "after") && !validDate(getIntValue(<%= SegmentConstants.ELEMENT_REGISTRATION_DATE_YEAR %>), getIntValue(<%= SegmentConstants.ELEMENT_REGISTRATION_DATE_MONTH %>), getIntValue(<%= SegmentConstants.ELEMENT_REGISTRATION_DATE_DAY %>))) {
		...
		if (selectValue == "withinTheLast" || selectValue == "notWithinTheLast") {
			 var days = getIntValue(<%= SegmentConstants.ELEMENT_REGISTRATION_DATE_DAYS %>);
		...
		if (selectValue == "range") {
				if (!validDate(getIntValue(<%= SegmentConstants.ELEMENT_REGISTRATION_DATE_YEAR_1 %>), getIntValue(<%= SegmentConstants.ELEMENT_REGISTRATION_DATE_MONTH_1 %>), getIntValue(<%= SegmentConstants.ELEMENT_REGISTRATION_DATE_DAY_1 %>))) {
					alertDialog("<%= UIUtil.toJavaScript((String) segmentsRB.get(SegmentConstants.MSG_INVALID_DATE)) %>");
				...
				if (!validDate(getIntValue(<%= SegmentConstants.ELEMENT_REGISTRATION_DATE_YEAR_2 %>), getIntValue(<%= SegmentConstants.ELEMENT_REGISTRATION_DATE_MONTH_2 %>), getIntValue(<%= SegmentConstants.ELEMENT_REGISTRATION_DATE_DAY_2 %>))) {
					alertDialog("<%= UIUtil.toJavaScript((String) segmentsRB.get(SegmentConstants.MSG_INVALID_DATE)) %>");
