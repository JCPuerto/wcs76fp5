...
<p><label for="<%= SegmentConstants.ELEMENT_REGISTRATION_CHANGE_DATE_OP %>"><%= segmentsRB.get(SegmentConstants.MSG_REGISTRATION_CHANGE_DATE_PANEL_TITLE) %></label><br>
<select name="<%= SegmentConstants.ELEMENT_REGISTRATION_CHANGE_DATE_OP %>" id="<%= SegmentConstants.ELEMENT_REGISTRATION_CHANGE_DATE_OP %>" onChange="showRegistrationChangeDate()">
	<option value="<%= SegmentConstants.VALUE_DO_NOT_USE %>"><%= segmentsRB.get(SegmentConstants.MSG_DO_NOT_USE_REGISTRATION_CHANGE_DATE) %></option>
	<option value="<%= SegmentConstants.VALUE_WITHIN_THE_LAST %>"><%= segmentsRB.get(SegmentConstants.MSG_REGISTRATION_CHANGE_DATE_WITHIN_THE_LAST) %></option>
	<option value="<%= SegmentConstants.VALUE_NOT_WITHIN_THE_LAST %>"><%= segmentsRB.get(SegmentConstants.MSG_REGISTRATION_CHANGE_DATE_NOT_WITHIN_THE_LAST) %></option>
	<option value="<%= SegmentConstants.VALUE_BEFORE %>"><%= segmentsRB.get(SegmentConstants.MSG_REGISTRATION_CHANGE_DATE_BEFORE) %></option>
	<option value="<%= SegmentConstants.VALUE_AFTER %>"><%= segmentsRB.get(SegmentConstants.MSG_REGISTRATION_CHANGE_DATE_AFTER) %></option>
	<option value="<%= SegmentConstants.VALUE_RANGE %>"><%= segmentsRB.get(SegmentConstants.MSG_REGISTRATION_CHANGE_DATE_RANGE) %></option>
</select>

<div id="registrationChangeDateDaysDiv" style="display: none; margin-left: 20">
<p><label for="<%= SegmentConstants.ELEMENT_REGISTRATION_CHANGE_DATE_DAYS %>"><%= segmentsRB.get(SegmentConstants.MSG_DAYS_PROMPT) %></label><br>
