...
if (localeStr.equals("zh_TW") || localeStr.equals("zh_CN") || localeStr.equals("ja_JP") 
     ...
     %>
        <%@ include file="CountryPanel.jsp" %>
<%
} else {
%>
	<%@ include file="CityPanel.jsp" %>
<%
}

if (localeStr.equals("ja_JP") || localeStr.equals("ko_KR")) {
     %>
	<%@ include file="ZipCodePanel.jsp" %>
<%
} else {
%>
	<%@ include file="StatePanel.jsp" %>
<%
}
...
%>
<%@ include file="PhonePanel.jsp" %>
<%@ include file="EMailPanel.jsp" %>
<p></p>
</FORM>
