...
function displayAddrItem(num)
{
   ...
   if (addrOrderList[num] == "street")
   {
      if (mandatory == true)
         ...
         println("<%=UIUtil.toJavaScript((String)user2NLS.get("street"))%><BR>");
   ...
   else if (addrOrderList[num] == "city")
   {
      if (mandatory == true)
         ...
         println("<%=UIUtil.toJavaScript((String)user2NLS.get("city"))%><BR>");
   ...
   else if (addrOrderList[num] == "state")
   {
      if (mandatory == true)
         ...
         println("<%=UIUtil.toJavaScript((String)user2NLS.get("state"))%><BR>");
	  ...
	  println("<select name='state' id='state1'>"); 
 	  ...
 	  %>
	  		println("<option value='<%=states[i].getAbbr()%>'><%=states[i].getName()%>");
	  <% } %>
   ...
   else if (addrOrderList[num] == "country")
   {
      if (mandatory == true)
         ...
         println("<%=UIUtil.toJavaScript((String)user2NLS.get("country"))%><BR>");
   ...
   else if (addrOrderList[num] == "zip")
   {
      if (mandatory == true)
         ...
         println("<%=UIUtil.toJavaScript((String)user2NLS.get("zip"))%><br>");
