...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tbody>
          ...
          <tr>
            <td valign="bottom"><label for="preferredCommunication1"><%=userNLS.get("preferredCommunication")%></label><br />
            <select name="preferredCommunication" id="preferredCommunication1">
            <option value="" selected="selected"><%=userNLS.get("notProvided")%></option>
          ...
          <tr>
            <td valign="bottom"><label for="email11"><%=userNLS.get("email1")%></label><br />
            <input size="30" type="text" name="email1" maxlength="254" id="email11" /></td>
	                
          </tr>
          <tr>
             <td valign="bottom" ><label for="email21"><%=userNLS.get("email2")%></label><br />
    ...
    <tr>
            ...
            <td valign="bottom"><label for="phone11"><%=userNLS.get("phone1")%></label><br />
...
<%          }
            if (showPhoneListed.equals("true")) {
%>           <td valign="bottom">
              <input type="checkbox" name="phone1Listed" value="1" id="phone1Listed1" /><label for="phone1Listed1"><%=userNLS.get("listed")%></label></td>
<%          }
%>        </tr>
          <tr>
            <td valign="bottom"><label for="phone21"><%=userNLS.get("phone2")%></label><br />
...
<%          }
            if (showPhoneListed.equals("true")) {
%>            <td valign="bottom">
              <input type="checkbox" name="phone2Listed" value="1" id="phone2Listed1" /><label for="phone2Listed1"><%=userNLS.get("listed")%></label></td>
<%          }
%>        </tr>
        
      
          <tr>
            <td valign="bottom"><label for="fax11"><%=userNLS.get("fax1")%></label><br />
            <input size="30" type="text" name="fax1" maxlength="32" id="fax11" /></td>
                       
          </tr>
          <tr>
            <td valign="bottom"><label for="fax21"><%=userNLS.get("fax2")%></label><br />
            <input size="30" type="text" name="fax2" maxlength="32" id="fax21" /></td>
          </tr>
          <tr>
            <td colspan="2" valign="bottom"><label for="bestTimeToCall1"><%=userNLS.get("bestTimeToCall")%></label><br />
