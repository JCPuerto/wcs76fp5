...
<title><%= assignCustomersRB .get("emailActivityDialogTitle") %></title>
</head>

<body onload="loadPanelData()" class="content">

<h1><%= assignCustomersRB.get("assignCustTitle") %> </h1>

<form name="assignCustForm">

<p><label for="SelectViewID"><%= assignCustomersRB.get("assignCustSelectView") %></label><br />
<select name="SelectView" id="SelectViewID" single ="SINGLE" onChange="changeView()">
       <option value="1" selected><%= assignCustomersRB.get("assignCustCustomerGroups") %></option>
       <option value="2"><%= assignCustomersRB.get("assignCustOrganizations") %></option>
       <option value="3"><%= assignCustomersRB.get("assignCustUsers") %></option>
</select><br />
<br />
...
<p><label for="assignedCustID"><%= assignCustomersRB.get("assignCustAssignedCust") %></label><br />
<table border="0" width="100%" height="48">
    <tr>
      ...
      <td width="74%" height="19">&nbsp;&nbsp;&nbsp;&nbsp;<button class="general" name="addButton" onclick="javascript:addCustomers()" disabled="true" ><%=assignCustomersRB.get("assignCustButAdd")%> </button>
         <BR></BR>&nbsp;&nbsp;&nbsp;&nbsp;<button class="general" name="removeButton" onclick="javascript:removeCustomers()" disabled="true" ><%=assignCustomersRB.get("assignCustButRemove")%> </button>
