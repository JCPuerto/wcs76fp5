...
%>
  ...
  <TR>
    <TD ALIGN="LEFT"><STRONG><LABEL for="actionGroup1"><%= policyNLS.get("policyActionGroupHeader") %></LABEL></STRONG></TR>
  <TR>
    <TD>
...
%>
  ...
  <TR>
    <TD ALIGN="LEFT"><STRONG><LABEL for="relation1"><%= policyNLS.get("policyRelationshipHeader") %></LABEL></STRONG></TR>
  <TR>
