												...
												<td class="logon" style="padding-left: 25px;">
													...
													<table border="0" cellpadding="5" cellspacing="0">
														<tbody>
															...
															<tr>																
																<td><input type="password" name="<%= ECUserConstants.EC_UREG_LOGONPASSWORDOLD %>" id="oldpassword1" size="16" maxlength="254"/></td>
															</tr>
															<tr>
																<td><label for="newpassword1"><%= newPasswordStr %></label></td>
															</tr>
															<tr>																
																<td><input type="password" name="<%= ECUserConstants.EC_UREG_LOGONPASSWORD %>" id="newpassword1" size="16" maxlength="254"/></td>
															</tr>
															<tr>
																<td><label for="newpassword2"><%= newPasswordVerifyStr %></label></td>
															</tr>
															<tr>																
																<td><input type="password" name="<%= ECUserConstants.EC_UREG_LOGONPASSWORDVERIFY %>" id="newpassword2" size="16" maxlength="254"/></td>
															</tr>
															<tr>
