...
<table width="791" cellpadding="0" cellspacing="0" border="0" id="WC_StatisticsLogon_Table_2">
    ...
    <tr>
     <td id="WC_StatisticsLogon_TableCell_8"><input type="password" name="<%= ECUserConstants.EC_UREG_LOGONPASSWORD %>" size="16" maxlength="254" id="<%= ECUserConstants.EC_UREG_LOGONPASSWORD %>" /></td>
    </tr>
    <tr>
