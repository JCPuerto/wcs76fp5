...
var isContentSearchEnabled = false;
<%
	boolean isContentSearchEnabled = false;
	//if (com.ibm.commerce.tools.common.ToolsConfiguration.getConfigString("component").indexOf("WebActivityContentSearch") >= 0 && com.ibm.commerce.tools.common.ToolsConfiguration.isComponentEnabled("WebActivityContentSearch")) {
...
function showWhatDivisions () {
	...
	if (whatTypeValue == "<%= CampaignConstants.WHAT_TYPE_DISCOUNT_COLLATERAL %>") {
		if (isContentSearchEnabled && !isPromotionLoaded) {
		...
		if (isContentSearchEnabled && !isCouponLoaded) {
			top.showProgressIndicator(true);
		...
		if (isContentSearchEnabled && !isCollateralLoaded) {
			top.showProgressIndicator(true);
...
<table id="WC_InitiativePanel_PromotionCollateralTable_1">
	<tr style="display: <%= isContentSearchEnabled ? "block" : "none" %>;">
	...
	<tr>
		...
		<td id="WC_InitiativePanel_PromotionCollateralCell_9" width="15px" style="display: <%= isContentSearchEnabled ? "block" : "none" %>;"></td>
		<td id="WC_InitiativePanel_PromotionCollateralCell_10" valign="top" style="display: <%= isContentSearchEnabled ? "block" : "none" %>;">
			<table id="WC_InitiativePanel_PromotionCollateralTable_3" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td id="WC_InitiativePanel_PromotionCollateralCell_13">
						<label for="promotionCollateralSearchType"><%= campaignsRB.get("searchcriteria") %></label><br/>
...
<table id="WC_InitiativePanel_CouponCollateralTable_1">
	...
	<tr>
		...
		<td id="WC_InitiativePanel_CouponCollateralCell_9" width="15px" style="display: <%= isContentSearchEnabled ? "block" : "none" %>;"></td>
		<td id="WC_InitiativePanel_CouponCollateralCell_10" valign="top" style="display: <%= isContentSearchEnabled ? "block" : "none" %>;">
			<table id="WC_InitiativePanel_CouponCollateralTable_3" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td id="WC_InitiativePanel_CouponCollateralCell_13">
						<label for="couponCollateralSearchType"><%= campaignsRB.get("searchcriteria") %></label><br/>
...
<table id="WC_InitiativePanel_CollateralTable_1">
	...
	<tr>
		...
		<td id="WC_InitiativePanel_CollateralCell_9" width="15px" style="display: <%= isContentSearchEnabled ? "block" : "none" %>;"></td>
		<td id="WC_InitiativePanel_CollateralCell_10" valign="top" style="display: <%= isContentSearchEnabled ? "block" : "none" %>;">
			<table id="WC_InitiativePanel_CollateralTable_3" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td id="WC_InitiativePanel_CollateralCell_13">
						<label for="collateralSearchType"><%= campaignsRB.get("searchcriteria") %></label><br/>
...
<input type="hidden" name="categoryIdentifier" id="validateCategoryIdentifier"/>
...
<input type="hidden" id="contentSearchType" name="searchType" />
...
<iframe id="contentSelectionSearchFrame" name="contentSelectionSearchFrame" title="contentSelectionSearchFrame" frameborder="0" scrolling="no" src="/wcs/tools/common/blank.html" width="0" height="0">
</iframe>
