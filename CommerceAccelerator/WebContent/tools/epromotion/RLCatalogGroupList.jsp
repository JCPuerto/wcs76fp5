...
%>
	     ...
	     <%= comm.addDlistCheck(category.getCategoryId()+";"+category.getIdentifier()+";"+category.getDescription(cmdContext.getLanguageId()).getName(),"setChecked(this);",category.getCategoryId() ) %>
