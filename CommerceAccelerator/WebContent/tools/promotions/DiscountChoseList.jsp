...
%>
           ...
           var discountMissMsg = "<%= (String)NLSfile.get("discountMissMsg") %>";
           var discountMoreMsg = "<%= (String)NLSfile.get("discountMoreMsg") %>";
           var ecCalcodeId = "<%= ECPromotionsConstants.EC_Calcode_Id%>";
           var ecCategoryId = "<%= ECConstants.EC_CATEGORY_ID%>";
