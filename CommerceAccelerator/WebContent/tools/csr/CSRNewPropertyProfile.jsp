  ...
  <tbody>
		   ...
		   <tr>
			   <td valign="bottom" id="CSRNewPropertyProfile_TableCell_2"><%=userNLS.get("passwordReq")%><br />
			      ...
			      <input size="30" type="password" name="pwd" maxlength="68" id="CSRNewPropertyProfile_FormInput_pwd_In_profile_1" />
      			   </td>
      		   </tr>
      		   <tr>
		   	      ...
		   	      <input size="30" type="password" name="pwd2" maxlength="68" id="CSRNewPropertyProfile_FormInput_pwd2_In_profile_1" />
      			   </td>
		   </tr>
