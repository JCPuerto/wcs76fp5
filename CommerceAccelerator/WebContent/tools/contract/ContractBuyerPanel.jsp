...
<%
   ...
   // ContractTCLockCommon.jsp, and change the myContractTCTypeID
   // accordingly.
   //----------------------------------------------------------------
...
<%--
   ...
   //
   // Include the JSP file ContractTCLockCommon.jsp which will
   ...
   //----------------------------------------------------------------
--%>
<%@include file="ContractTCLockCommon.jsp" %>
