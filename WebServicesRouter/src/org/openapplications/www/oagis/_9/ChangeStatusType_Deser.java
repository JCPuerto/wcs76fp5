...
public class ChangeStatusType_Deser extends org.openapplications.www.oagis._9.StatusBasisType_Deser {
    /**
     * Constructor
     */
    public ChangeStatusType_Deser(
    ...
    protected boolean tryElementSetFromObject(javax.xml.namespace.QName qName, java.lang.Object objValue) {
        if (qName==QName_1_51) {
          if (objValue instanceof java.util.List) {
            ...
            ((ChangeStatusType)value).setUserArea(array);
          } else { 
            ((ChangeStatusType)value).setUserArea((javax.xml.soap.SOAPElement[])objValue);}
          return true;}
    ...
    protected boolean tryElementSetFromList(javax.xml.namespace.QName qName, java.util.List listValue) {
        if (qName==QName_1_107) {
          ...
          ((ChangeStatusType)value).setStateChange(array);
          return true;}
    ...
    private final static javax.xml.namespace.QName QName_1_51 = 
           com.ibm.ws.webservices.engine.utils.QNameTable.createQName(
                  ...
                  "UserArea");
    private final static javax.xml.namespace.QName QName_1_107 = 
           com.ibm.ws.webservices.engine.utils.QNameTable.createQName(
                  "http://www.openapplications.org/oagis/9",
                  "StateChange");
}
