/**
 * CurrencyExchangeRateType_Deser.java
 *
...
public class CurrencyExchangeRateType_Deser extends org.openapplications.www.oagis._9.CurrencyExchangeBaseType_Deser {
    /**
     * Constructor
     */
    public CurrencyExchangeRateType_Deser(
    ...
    public void createValue() {
        value = new CurrencyExchangeRateType();
    }
    ...
    protected boolean tryElementSetFromObject(javax.xml.namespace.QName qName, java.lang.Object objValue) {
        if (qName==QName_1_51) {
          if (objValue instanceof java.util.List) {
            ...
            ((CurrencyExchangeRateType)value).setUserArea(array);
          } else { 
            ((CurrencyExchangeRateType)value).setUserArea((javax.xml.soap.SOAPElement[])objValue);}
          return true;}
