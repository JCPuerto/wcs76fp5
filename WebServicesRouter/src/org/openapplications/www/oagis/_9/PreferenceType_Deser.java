...
public class PreferenceType_Deser extends org.openapplications.www.oagis._9.PreferenceABIEType_Deser {
    /**
     * Constructor
     */
    public PreferenceType_Deser(
    ...
    protected boolean tryElementSetFromObject(javax.xml.namespace.QName qName, java.lang.Object objValue) {
        if (qName==QName_1_51) {
          if (objValue instanceof java.util.List) {
            ...
            ((PreferenceType)value).setUserArea(array);
          } else { 
            ((PreferenceType)value).setUserArea((javax.xml.soap.SOAPElement[])objValue);}
          return true;}
