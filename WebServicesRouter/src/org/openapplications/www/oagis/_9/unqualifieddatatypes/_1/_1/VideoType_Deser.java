...
public class VideoType_Deser extends com.ibm.ws.webservices.engine.encoding.ser.SimpleBeanDeserializer {
    /**
     * Constructor
     */
    public VideoType_Deser(
    ...
    protected boolean tryAttributeSetFromString(javax.xml.namespace.QName qName, java.lang.String strValue) {
        if (qName==QName_0_7) {
          ((VideoType)value).setFormat(strValue);
          return true;}
        else if (qName==QName_0_11) {
          ((VideoType)value).setEncodingCode(strValue);
          return true;}
        else if (qName==QName_0_16) {
          ((VideoType)value).setFilename(strValue);
          return true;}
        return false;
    }
    protected boolean tryElementSetFromObject(javax.xml.namespace.QName qName, java.lang.Object objValue) {
        if (qName==QName_0_2) {
          ((VideoType)value).set_value((byte[])objValue);
          return true;}
        return false;
    }
