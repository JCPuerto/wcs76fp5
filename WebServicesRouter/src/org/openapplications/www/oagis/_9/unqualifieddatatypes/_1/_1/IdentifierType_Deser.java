...
public class IdentifierType_Deser extends com.ibm.ws.webservices.engine.encoding.ser.SimpleBeanDeserializer {
    /**
     * Constructor
     */
    public IdentifierType_Deser(
    ...
    public void createValue() {
        value = new IdentifierType();
    }
    protected boolean tryElementSetFromString(javax.xml.namespace.QName qName, java.lang.String strValue) {
        if (qName==QName_0_2) {
          ((IdentifierType)value).set_value(strValue);
          return true;}
        return false;
    }
    protected boolean tryAttributeSetFromString(javax.xml.namespace.QName qName, java.lang.String strValue) {
        if (qName==QName_0_27) {
          ((IdentifierType)value).setSchemeID(strValue);
          return true;}
        else if (qName==QName_0_28) {
          ((IdentifierType)value).setSchemeName(strValue);
          return true;}
        else if (qName==QName_0_29) {
          ((IdentifierType)value).setSchemeAgencyID(strValue);
          return true;}
        else if (qName==QName_0_30) {
          ((IdentifierType)value).setSchemeAgencyName(strValue);
          return true;}
        else if (qName==QName_0_31) {
          ((IdentifierType)value).setSchemeVersionID(strValue);
          return true;}
        return false;
    }
