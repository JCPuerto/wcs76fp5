...
public class SoundType_Deser extends com.ibm.ws.webservices.engine.encoding.ser.SimpleBeanDeserializer {
    /**
     * Constructor
     */
    public SoundType_Deser(
    ...
    protected boolean tryAttributeSetFromString(javax.xml.namespace.QName qName, java.lang.String strValue) {
        if (qName==QName_0_7) {
          ((SoundType)value).setFormat(strValue);
          return true;}
        else if (qName==QName_0_11) {
          ((SoundType)value).setEncodingCode(strValue);
          return true;}
        else if (qName==QName_0_16) {
          ((SoundType)value).setFilename(strValue);
          return true;}
        return false;
    }
    protected boolean tryElementSetFromObject(javax.xml.namespace.QName qName, java.lang.Object objValue) {
        if (qName==QName_0_2) {
          ((SoundType)value).set_value((byte[])objValue);
          return true;}
        return false;
    }
