...
public class PictureType_Deser extends com.ibm.ws.webservices.engine.encoding.ser.SimpleBeanDeserializer {
    /**
     * Constructor
     */
    public PictureType_Deser(
    ...
    protected boolean tryAttributeSetFromString(javax.xml.namespace.QName qName, java.lang.String strValue) {
        if (qName==QName_0_7) {
          ((PictureType)value).setFormat(strValue);
          return true;}
        else if (qName==QName_0_11) {
          ((PictureType)value).setEncodingCode(strValue);
          return true;}
        else if (qName==QName_0_16) {
          ((PictureType)value).setFilename(strValue);
          return true;}
        return false;
    }
    protected boolean tryElementSetFromObject(javax.xml.namespace.QName qName, java.lang.Object objValue) {
        if (qName==QName_0_2) {
          ((PictureType)value).set_value((byte[])objValue);
          return true;}
        return false;
    }
