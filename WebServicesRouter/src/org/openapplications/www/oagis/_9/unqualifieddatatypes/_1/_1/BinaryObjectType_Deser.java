...
public class BinaryObjectType_Deser extends com.ibm.ws.webservices.engine.encoding.ser.SimpleBeanDeserializer {
    /**
     * Constructor
     */
    public BinaryObjectType_Deser(
    ...
    protected boolean tryAttributeSetFromString(javax.xml.namespace.QName qName, java.lang.String strValue) {
        if (qName==QName_0_7) {
          ((BinaryObjectType)value).setFormat(strValue);
          return true;}
        else if (qName==QName_0_11) {
          ((BinaryObjectType)value).setEncodingCode(strValue);
          return true;}
        else if (qName==QName_0_13) {
          ((BinaryObjectType)value).setCharacterSetCode(strValue);
          return true;}
        else if (qName==QName_0_16) {
          ((BinaryObjectType)value).setFilename(strValue);
          return true;}
        return false;
    }
    protected boolean tryElementSetFromObject(javax.xml.namespace.QName qName, java.lang.Object objValue) {
        if (qName==QName_0_2) {
          ((BinaryObjectType)value).set_value((byte[])objValue);
          return true;}
        return false;
    }
