...
public class AmountType_Ser extends com.ibm.ws.webservices.engine.encoding.ser.SimpleBeanSerializer {
    /**
     * Constructor
     */
    public AmountType_Ser(
    ...
    public java.lang.String getValueAsString(
        ...
        com.ibm.ws.webservices.engine.encoding.SerializationContext context)
    {
        AmountType bean = (AmountType) value;
        ...
        throws java.io.IOException
    {
        ...
        }
        {
          ...
          propValue = bean.getCurrencyID();
          if (propValue != null) {        
            attrQName = QName_0_4;
            attrTypeQName = QName_2_5;
            attrs.addAttribute(
              "",
              "currencyID",
