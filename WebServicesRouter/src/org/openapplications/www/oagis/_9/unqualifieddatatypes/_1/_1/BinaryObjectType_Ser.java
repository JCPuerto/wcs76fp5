...
public class BinaryObjectType_Ser extends com.ibm.ws.webservices.engine.encoding.ser.SimpleBeanSerializer {
    /**
     * Constructor
     */
    public BinaryObjectType_Ser(
    ...
    public java.lang.String getValueAsString(
        ...
        com.ibm.ws.webservices.engine.encoding.SerializationContext context)
    {
        BinaryObjectType bean = (BinaryObjectType) value;
        ...
        throws java.io.IOException
    {
        ...
        }
        {
          ...
          propValue = bean.getCharacterSetCode();
          if (propValue != null) {        
            attrQName = QName_0_13;
            attrTypeQName = QName_3_12;
            attrs.addAttribute(
              "",
              "characterSetCode",
