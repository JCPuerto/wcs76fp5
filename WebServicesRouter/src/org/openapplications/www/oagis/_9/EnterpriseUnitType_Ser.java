...
public class EnterpriseUnitType_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public EnterpriseUnitType_Ser(
        ...
        throws java.io.IOException
    {
           ...
           elemQName = QName_1_248;
           context.qName2String(elemQName, true);
           elemQName = QName_1_249;
           context.qName2String(elemQName, true);
           elemQName = QName_1_250;
           context.qName2String(elemQName, true);
    ...
    protected void addElements(
        ...
        throws java.io.IOException
    {
        EnterpriseUnitType bean = (EnterpriseUnitType) value;
        java.lang.Object propValue;
        javax.xml.namespace.QName propQName;
        {
          propQName = QName_1_248;
          propValue = bean.getCostCenterID();
          serializeChild(propQName, null, 
              propValue, 
              QName_1_55,
              false,null,context);
          propQName = QName_1_249;
          propValue = bean.getProfitCenterID();
          serializeChild(propQName, null, 
              propValue, 
              QName_1_55,
              false,null,context);
          propQName = QName_1_250;
          {
            propValue = bean.getGLEntityID();
            if (propValue != null) {
