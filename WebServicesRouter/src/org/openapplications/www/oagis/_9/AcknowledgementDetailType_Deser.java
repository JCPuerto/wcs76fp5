/**
 * AcknowledgementDetailType_Deser.java
 *
...
public class AcknowledgementDetailType_Deser extends org.openapplications.www.oagis._9.StatusABIEType_Deser {
    /**
     * Constructor
     */
    public AcknowledgementDetailType_Deser(
    ...
    public void createValue() {
        value = new AcknowledgementDetailType();
    }
    ...
    protected boolean tryElementSetFromObject(javax.xml.namespace.QName qName, java.lang.Object objValue) {
        if (qName==QName_1_51) {
          if (objValue instanceof java.util.List) {
            ...
            ((AcknowledgementDetailType)value).setUserArea(array);
          } else { 
            ((AcknowledgementDetailType)value).setUserArea((javax.xml.soap.SOAPElement[])objValue);}
          return true;}
