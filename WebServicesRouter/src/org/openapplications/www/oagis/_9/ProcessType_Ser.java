...
public class ProcessType_Ser extends org.openapplications.www.oagis._9.ActionVerbType_Ser {
    /**
     * Constructor
     */
    public ProcessType_Ser(
        ...
        throws java.io.IOException
    {
        ...
        ProcessType bean = (ProcessType) value;
        ...
        }
        {
          ...
          propValue = bean.getAcknowledgeCode();
          if (propValue != null) {        
            attrQName = QName_0_95;
