/**
 * BusinessObjectDocumentType_Deser.java
 *
...
public class BusinessObjectDocumentType_Deser extends com.ibm.ws.webservices.engine.encoding.ser.BeanDeserializer {
    /**
     * Constructor
     */
    public BusinessObjectDocumentType_Deser(
    ...
    public void createValue() {
        value = new BusinessObjectDocumentType();
    }
    ...
    protected boolean tryAttributeSetFromString(javax.xml.namespace.QName qName, java.lang.String strValue) {
        if (qName==QName_0_38) {
          ((BusinessObjectDocumentType)value).setReleaseID(strValue);
          return true;}
        else if (qName==QName_0_40) {
          ((BusinessObjectDocumentType)value).setVersionID(strValue);
          return true;}
        return false;
    }
    protected boolean tryElementSetFromObject(javax.xml.namespace.QName qName, java.lang.Object objValue) {
        if (qName==QName_1_45) {
          ((BusinessObjectDocumentType)value).setApplicationArea((org.openapplications.www.oagis._9.ApplicationAreaType)objValue);
          return true;}
        return false;
    }
