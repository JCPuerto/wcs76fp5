...
public class DimensionType_Deser extends org.openapplications.www.oagis._9.DimensionABIEType_Deser {
    /**
     * Constructor
     */
    public DimensionType_Deser(
    ...
    protected boolean tryElementSetFromObject(javax.xml.namespace.QName qName, java.lang.Object objValue) {
        if (qName==QName_1_51) {
          if (objValue instanceof java.util.List) {
            ...
            ((DimensionType)value).setUserArea(array);
          } else { 
            ((DimensionType)value).setUserArea((javax.xml.soap.SOAPElement[])objValue);}
          return true;}
