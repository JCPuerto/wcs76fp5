/**
 * SemanticContactType_Deser.java
 *
...
public class SemanticContactType_Deser extends org.openapplications.www.oagis._9.ContactABIEType_Deser {
    /**
     * Constructor
     */
    public SemanticContactType_Deser(
    ...
    protected boolean tryElementSetFromObject(javax.xml.namespace.QName qName, java.lang.Object objValue) {
        if (qName==QName_1_51) {
          if (objValue instanceof java.util.List) {
            ...
            ((SemanticContactType)value).setUserArea(array);
          } else { 
            ((SemanticContactType)value).setUserArea((javax.xml.soap.SOAPElement[])objValue);}
          return true;}
