...
public class ReviewerPartyType_Deser extends org.openapplications.www.oagis._9.PartyBaseType_Deser {
    /**
     * Constructor
     */
    public ReviewerPartyType_Deser(
    ...
    protected boolean tryElementSetFromObject(javax.xml.namespace.QName qName, java.lang.Object objValue) {
        if (qName==QName_1_51) {
          if (objValue instanceof java.util.List) {
            ...
            ((ReviewerPartyType)value).setUserArea(array);
          } else { 
            ((ReviewerPartyType)value).setUserArea((javax.xml.soap.SOAPElement[])objValue);}
          return true;}
    ...
    protected boolean tryElementSetFromList(javax.xml.namespace.QName qName, java.util.List listValue) {
        if (qName==QName_1_224) {
          ...
          ((ReviewerPartyType)value).setReviewerContact(array);
          return true;}
    ...
    private final static javax.xml.namespace.QName QName_1_51 = 
           com.ibm.ws.webservices.engine.utils.QNameTable.createQName(
                  ...
                  "UserArea");
    private final static javax.xml.namespace.QName QName_1_224 = 
           com.ibm.ws.webservices.engine.utils.QNameTable.createQName(
                  "http://www.openapplications.org/oagis/9",
                  "ReviewerContact");
}
