...
public class UserType_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public UserType_Ser(
        ...
        throws java.io.IOException
    {
           ...
           elemQName = QName_1_160;
           context.qName2String(elemQName, true);
           elemQName = QName_1_161;
           context.qName2String(elemQName, true);
        ...
        throws java.io.IOException
    {
        ...
        javax.xml.namespace.QName propQName;
        {
          ...
          serializeChild(propQName, null, 
              ...
              QName_1_55,
              false,null,context);
          propQName = QName_1_160;
          {
            propValue = bean.getGroupID();
            if (propValue != null) {
          ...
          propQName = QName_1_161;
          {
            propValue = bean.getUserAccount();
            if (propValue != null) {
              for (int i=0; i<java.lang.reflect.Array.getLength(propValue); i++) {
                serializeChild(propQName, null, 
                    java.lang.reflect.Array.get(propValue, i), 
    ...
    private final static javax.xml.namespace.QName QName_1_56 = 
           com.ibm.ws.webservices.engine.utils.QNameTable.createQName(
                  "http://www.openapplications.org/oagis/9",
                  "UserAreaType");
    private final static javax.xml.namespace.QName QName_1_162 = 
           com.ibm.ws.webservices.engine.utils.QNameTable.createQName(
                  "http://www.openapplications.org/oagis/9",
                  "UserAccountType");
}
