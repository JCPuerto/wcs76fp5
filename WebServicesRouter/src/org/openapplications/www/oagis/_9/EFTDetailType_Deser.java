...
public class EFTDetailType_Deser extends org.openapplications.www.oagis._9.EFTDetailBaseType_Deser {
    /**
     * Constructor
     */
    public EFTDetailType_Deser(
    ...
    protected boolean tryElementSetFromObject(javax.xml.namespace.QName qName, java.lang.Object objValue) {
        if (qName==QName_1_128) {
          ((EFTDetailType)value).setID((javax.xml.soap.SOAPElement)objValue);
          return true;}
          ...
          if (objValue instanceof java.util.List) {
            ...
            ((EFTDetailType)value).setUserArea(array);
          } else { 
            ((EFTDetailType)value).setUserArea((javax.xml.soap.SOAPElement[])objValue);}
          return true;}
