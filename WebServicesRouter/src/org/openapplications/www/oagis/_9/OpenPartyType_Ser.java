...
public class OpenPartyType_Ser extends org.openapplications.www.oagis._9.PartyBaseType_Ser {
    /**
     * Constructor
     */
    public OpenPartyType_Ser(
        ...
        throws java.io.IOException
    {
        ...
        OpenPartyType bean = (OpenPartyType) value;
        ...
        }
        {
          ...
          propValue = bean.getRole();
          if (propValue != null) {        
            attrQName = QName_0_209;
            attrTypeQName = QName_1_210;
            attrs.addAttribute(
              "",
              "role",
    ...
    private final static javax.xml.namespace.QName QName_1_210 = 
