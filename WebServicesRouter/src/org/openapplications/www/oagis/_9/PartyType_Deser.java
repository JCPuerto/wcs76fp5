...
public class PartyType_Deser extends org.openapplications.www.oagis._9.OpenPartyType_Deser {
    /**
     * Constructor
     */
    public PartyType_Deser(
    ...
    protected boolean tryElementSetFromObject(javax.xml.namespace.QName qName, java.lang.Object objValue) {
        if (qName==QName_1_51) {
          if (objValue instanceof java.util.List) {
            ...
            ((PartyType)value).setUserArea(array);
          } else { 
            ((PartyType)value).setUserArea((javax.xml.soap.SOAPElement[])objValue);}
          return true;}
