/**
 * HazardousMaterialType_Deser.java
 *
...
public class HazardousMaterialType_Deser extends org.openapplications.www.oagis._9.HazardousMaterialABIEType_Deser {
    /**
     * Constructor
     */
    public HazardousMaterialType_Deser(
    ...
    public void createValue() {
        value = new HazardousMaterialType();
    }
    ...
    protected boolean tryElementSetFromObject(javax.xml.namespace.QName qName, java.lang.Object objValue) {
        if (qName==QName_1_51) {
          if (objValue instanceof java.util.List) {
            ...
            ((HazardousMaterialType)value).setUserArea(array);
          } else { 
            ((HazardousMaterialType)value).setUserArea((javax.xml.soap.SOAPElement[])objValue);}
          return true;}
