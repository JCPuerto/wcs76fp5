...
public class FailureMessageType_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public FailureMessageType_Ser(
        ...
        throws java.io.IOException
    {
           ...
           elemQName = QName_1_68;
           context.qName2String(elemQName, true);
           elemQName = QName_1_66;
           context.qName2String(elemQName, true);
    ...
    protected void addElements(
        ...
        throws java.io.IOException
    {
        FailureMessageType bean = (FailureMessageType) value;
        java.lang.Object propValue;
        javax.xml.namespace.QName propQName;
        {
          propQName = QName_1_68;
          {
            propValue = bean.getErrorProcessMessage();
            if (propValue != null) {
          ...
          propQName = QName_1_66;
          {
            propValue = bean.getWarningProcessMessage();
            if (propValue != null) {
              for (int i=0; i<java.lang.reflect.Array.getLength(propValue); i++) {
                serializeChild(propQName, null, 
                    java.lang.reflect.Array.get(propValue, i), 
