/**
 * LicenseIndicatorType_Helper.java
 *
...
public class LicenseIndicatorType_Helper {
    // Type metadata
    private static final com.ibm.ws.webservices.engine.description.TypeDesc typeDesc =
        new com.ibm.ws.webservices.engine.description.TypeDesc(LicenseIndicatorType.class);
    ...
    static {
        ...
        field.setXmlType(com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://www.openapplications.org/oagis/9", "LicenseTypeCodeContentType"));
    ...
    public static com.ibm.ws.webservices.engine.encoding.Deserializer getDeserializer(
           ...
           javax.xml.namespace.QName xmlType) {
        return 
          new LicenseIndicatorType_Deser(
            javaType, xmlType, typeDesc);
    };
