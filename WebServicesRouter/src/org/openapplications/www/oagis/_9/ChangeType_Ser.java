...
public class ChangeType_Ser extends org.openapplications.www.oagis._9.ActionVerbType_Ser {
    /**
     * Constructor
     */
    public ChangeType_Ser(
        ...
        throws java.io.IOException
    {
        ...
        ChangeType bean = (ChangeType) value;
        ...
        }
        {
          ...
          if (propValue != null) {        
            attrQName = QName_0_85;
            attrTypeQName = QName_1_86;
            attrs.addAttribute(
              "",
              "responseCode",
