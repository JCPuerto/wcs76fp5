...
public class SemanticPartyType_Deser extends org.openapplications.www.oagis._9.PartyBaseType_Deser {
    /**
     * Constructor
     */
    public SemanticPartyType_Deser(
    ...
    protected boolean tryElementSetFromObject(javax.xml.namespace.QName qName, java.lang.Object objValue) {
        if (qName==QName_1_51) {
          if (objValue instanceof java.util.List) {
            ...
            ((SemanticPartyType)value).setUserArea(array);
          } else { 
            ((SemanticPartyType)value).setUserArea((javax.xml.soap.SOAPElement[])objValue);}
          return true;}
