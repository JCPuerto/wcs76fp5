...
public class StatusType_Deser extends org.openapplications.www.oagis._9.StatusABIEType_Deser {
    /**
     * Constructor
     */
    public StatusType_Deser(
    ...
    protected boolean tryElementSetFromObject(javax.xml.namespace.QName qName, java.lang.Object objValue) {
        if (qName==QName_1_51) {
          if (objValue instanceof java.util.List) {
            ...
            ((StatusType)value).setUserArea(array);
          } else { 
            ((StatusType)value).setUserArea((javax.xml.soap.SOAPElement[])objValue);}
          return true;}
