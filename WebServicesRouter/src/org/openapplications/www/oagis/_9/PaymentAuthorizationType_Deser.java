/**
 * PaymentAuthorizationType_Deser.java
 *
...
public class PaymentAuthorizationType_Deser extends org.openapplications.www.oagis._9.PaymentAuthorizationABIEType_Deser {
    /**
     * Constructor
     */
    public PaymentAuthorizationType_Deser(
    ...
    public void createValue() {
        value = new PaymentAuthorizationType();
    }
    ...
    protected boolean tryElementSetFromObject(javax.xml.namespace.QName qName, java.lang.Object objValue) {
        if (qName==QName_1_51) {
          if (objValue instanceof java.util.List) {
            ...
            ((PaymentAuthorizationType)value).setUserArea(array);
          } else { 
            ((PaymentAuthorizationType)value).setUserArea((javax.xml.soap.SOAPElement[])objValue);}
          return true;}
